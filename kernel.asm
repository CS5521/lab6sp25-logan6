...
8010003a:	c7 44 24 04 34 82 10 	movl   $0x80108234,0x4(%esp)
80100041:	80 
...
80100087:	c7 44 24 04 3b 82 10 	movl   $0x8010823b,0x4(%esp)
8010008e:	80 
...
801001a7:	c7 04 24 42 82 10 80 	movl   $0x80108242,(%esp)
...
80100202:	75 0c                	jne    80100210 <bwrite+0x24>
    panic("bwrite");
80100204:	c7 04 24 53 82 10 80 	movl   $0x80108253,(%esp)
...
80100242:	75 0c                	jne    80100250 <brelse+0x24>
    panic("brelse");
80100244:	c7 04 24 5a 82 10 80 	movl   $0x8010825a,(%esp)
...
801003ed:	75 0c                	jne    801003fb <cprintf+0x33>
    panic("null fmt");
801003ef:	c7 04 24 61 82 10 80 	movl   $0x80108261,(%esp)
...
801004d6:	75 09                	jne    801004e1 <cprintf+0x119>
        s = "(null)";
801004d8:	c7 45 ec 6a 82 10 80 	movl   $0x8010826a,-0x14(%ebp)
      for(; *s; s++)
...
80100580:	c7 04 24 71 82 10 80 	movl   $0x80108271,(%esp)
...
80100592:	e8 31 fe ff ff       	call   801003c8 <cprintf>
  cprintf("\n");
80100597:	c7 04 24 85 82 10 80 	movl   $0x80108285,(%esp)
...
801005c9:	c7 04 24 87 82 10 80 	movl   $0x80108287,(%esp)
...
801006ba:	c7 04 24 8b 82 10 80 	movl   $0x8010828b,(%esp)
...
80100ad6:	c7 44 24 04 9e 82 10 	movl   $0x8010829e,0x4(%esp)
80100add:	80 
...
80100b48:	e8 be 29 00 00       	call   8010350b <end_op>
    cprintf("exec: fail\n");
80100b4d:	c7 04 24 a6 82 10 80 	movl   $0x801082a6,(%esp)
...
80100bb1:	e9 85 03 00 00       	jmp    80100f3b <exec+0x41d>
  ...
  if((pgdir = setupkvm()) == 0)
80100bb6:	e8 c4 6d 00 00       	call   8010797f <setupkvm>
...
80100c74:	e8 dc 70 00 00       	call   80107d55 <allocuvm>
...
80100cc6:	e8 a7 6f 00 00       	call   80107c72 <loaduvm>
...
80100d34:	e8 1c 70 00 00       	call   80107d55 <allocuvm>
...
80100d59:	e8 6a 72 00 00       	call   80107fc8 <clearpteu>
  sp = sz;
...
80100de8:	e8 9e 73 00 00       	call   8010818b <copyout>
...
80100e8f:	e8 f7 72 00 00       	call   8010818b <copyout>
...
80100f24:	e8 30 6b 00 00       	call   80107a59 <switchuvm>
  freevm(oldpgdir);
80100f29:	8b 45 cc             	mov    -0x34(%ebp),%eax
80100f2c:	89 04 24             	mov    %eax,(%esp)
80100f2f:	e8 fd 6f 00 00       	call   80107f31 <freevm>
  return 0;
...
80100f47:	e8 e5 6f 00 00       	call   80107f31 <freevm>
  if(ip){
...
80100f6f:	c7 44 24 04 b2 82 10 	movl   $0x801082b2,0x4(%esp)
80100f76:	80 
...
80100fff:	7f 0c                	jg     8010100d <filedup+0x28>
    panic("filedup");
80101001:	c7 04 24 b9 82 10 80 	movl   $0x801082b9,(%esp)
...
80101047:	7f 0c                	jg     80101055 <fileclose+0x28>
    panic("fileclose");
80101049:	c7 04 24 c1 82 10 80 	movl   $0x801082c1,(%esp)
...
801011fe:	eb 0c                	jmp    8010120c <fileread+0xba>
  ...
  panic("fileread");
80101200:	c7 04 24 cb 82 10 80 	movl   $0x801082cb,(%esp)
...
8010130c:	c7 04 24 d4 82 10 80 	movl   $0x801082d4,(%esp)
...
8010133c:	eb 0c                	jmp    8010134a <filewrite+0x13c>
  ...
  panic("filewrite");
8010133e:	c7 04 24 e4 82 10 80 	movl   $0x801082e4,(%esp)
...
80101517:	c7 04 24 f0 82 10 80 	movl   $0x801082f0,(%esp)
...
801015a6:	c7 04 24 06 83 10 80 	movl   $0x80108306,(%esp)
...
80101600:	c7 44 24 04 19 83 10 	movl   $0x80108319,0x4(%esp)
80101607:	80 
...
80101635:	c7 44 24 04 20 83 10 	movl   $0x80108320,0x4(%esp)
8010163c:	80 
...
801016af:	c7 04 24 28 83 10 80 	movl   $0x80108328,(%esp)
...
8010178a:	c7 04 24 7b 83 10 80 	movl   $0x8010837b,(%esp)
...
801018e3:	c7 04 24 8d 83 10 80 	movl   $0x8010838d,(%esp)
...
80101971:	7f 0c                	jg     8010197f <ilock+0x22>
    panic("ilock");
80101973:	c7 04 24 9d 83 10 80 	movl   $0x8010839d,(%esp)
...
80101a5a:	75 0c                	jne    80101a68 <ilock+0x10b>
      panic("ilock: no type");
80101a5c:	c7 04 24 a3 83 10 80 	movl   $0x801083a3,(%esp)
...
80101a90:	7f 0c                	jg     80101a9e <iunlock+0x34>
    panic("iunlock");
80101a92:	c7 04 24 b2 83 10 80 	movl   $0x801083b2,(%esp)
...
80101c7e:	c7 04 24 ba 83 10 80 	movl   $0x801083ba,(%esp)
...
80102122:	c7 04 24 cd 83 10 80 	movl   $0x801083cd,(%esp)
...
80102160:	c7 04 24 df 83 10 80 	movl   $0x801083df,(%esp)
...
80102243:	74 0c                	je     80102251 <dirlink+0x79>
      panic("dirlink read");
80102245:	c7 04 24 ee 83 10 80 	movl   $0x801083ee,(%esp)
...
801022ba:	74 0c                	je     801022c8 <dirlink+0xf0>
    panic("dirlink");
801022bc:	c7 04 24 fb 83 10 80 	movl   $0x801083fb,(%esp)
...
801025aa:	c7 44 24 04 03 84 10 	movl   $0x80108403,0x4(%esp)
801025b1:	80 
...
80102648:	75 0c                	jne    80102656 <idestart+0x18>
    panic("idestart");
8010264a:	c7 04 24 07 84 10 80 	movl   $0x80108407,(%esp)
...
80102663:	c7 04 24 10 84 10 80 	movl   $0x80108410,(%esp)
...
801026b5:	c7 04 24 07 84 10 80 	movl   $0x80108407,(%esp)
...
801028a3:	c7 04 24 22 84 10 80 	movl   $0x80108422,(%esp)
...
801028bc:	c7 04 24 38 84 10 80 	movl   $0x80108438,(%esp)
...
801028db:	c7 04 24 4d 84 10 80 	movl   $0x8010844d,(%esp)
...
801029e2:	c7 04 24 6c 84 10 80 	movl   $0x8010846c,(%esp)
...
80102a84:	c7 44 24 04 9e 84 10 	movl   $0x8010849e,0x4(%esp)
80102a8b:	80 
...
80102b3b:	76 0c                	jbe    80102b49 <kfree+0x36>
    panic("kfree");
80102b3d:	c7 04 24 a3 84 10 80 	movl   $0x801084a3,(%esp)
...
80103289:	c7 44 24 04 a9 84 10 	movl   $0x801084a9,0x4(%esp)
80103290:	80 
...
8010353a:	c7 04 24 ad 84 10 80 	movl   $0x801084ad,(%esp)
...
801036b4:	c7 04 24 bc 84 10 80 	movl   $0x801084bc,(%esp)
...
801036c9:	c7 04 24 d2 84 10 80 	movl   $0x801084d2,(%esp)
...
801037b4:	e8 c5 30 00 00       	call   8010687e <uartinit>
  pinit();         // process table
801037b9:	e8 f0 08 00 00       	call   801040ae <pinit>
  tvinit();        // trap vectors
801037be:	e8 84 2c 00 00       	call   80106447 <tvinit>
  binit();         // buffer cache
...
801037f8:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
801037fb:	e8 3f 42 00 00       	call   80107a3f <switchkvm>
  seginit();
80103800:	e8 ef 3c 00 00       	call   801074f4 <seginit>
  lapicinit();
...
8010382a:	c7 04 24 ed 84 10 80 	movl   $0x801084ed,(%esp)
80103831:	e8 92 cb ff ff       	call   801003c8 <cprintf>
  idtinit();       // load idt register
80103836:	e8 80 2d 00 00       	call   801065bb <idtinit>
...
801039bb:	00 
801039bc:	c7 44 24 04 04 85 10 	movl   $0x80108504,0x4(%esp)
801039c3:	80 
...
80103af9:	00 
80103afa:	c7 44 24 04 09 85 10 	movl   $0x80108509,0x4(%esp)
80103b01:	80 
...
80103b80:	c7 04 24 0e 85 10 80 	movl   $0x8010850e,(%esp)
...
80103bc9:	8b 04 85 48 85 10 80 	mov    -0x7fef7ab8(,%eax,4),%eax
...
80103c48:	c7 04 24 28 85 10 80 	movl   $0x80108528,(%esp)
...
80103d7d:	c7 44 24 04 5c 85 10 	movl   $0x8010855c,0x4(%esp)
80103d84:	80 
...
801040b4:	c7 44 24 04 64 85 10 	movl   $0x80108564,0x4(%esp)
801040bb:	80 
...
801040ff:	c7 04 24 6c 85 10 80 	movl   $0x8010856c,(%esp)
...
80104153:	c7 04 24 92 85 10 80 	movl   $0x80108592,(%esp)
...
80104241:	ba 02 64 10 80       	mov    $0x80106402,%edx
...
8010429f:	e8 db 36 00 00       	call   8010797f <setupkvm>
...
801042b4:	c7 04 24 a2 85 10 80 	movl   $0x801085a2,(%esp)
...
801042da:	e8 0b 39 00 00       	call   80107bea <inituvm>
  p->sz = PGSIZE;
...
8010437a:	00 
8010437b:	c7 44 24 04 bb 85 10 	movl   $0x801085bb,0x4(%esp)
80104382:	80 
80104383:	89 04 24             	mov    %eax,(%esp)
80104386:	e8 9f 0e 00 00       	call   8010522a <safestrcpy>
  p->cwd = namei("/");
8010438b:	c7 04 24 c4 85 10 80 	movl   $0x801085c4,(%esp)
...
801043f9:	e8 57 39 00 00       	call   80107d55 <allocuvm>
...
80104430:	e8 36 3a 00 00       	call   80107e6b <deallocuvm>
...
80104453:	e8 01 36 00 00       	call   80107a59 <switchuvm>
  return 0;
...
8010449a:	e8 6f 3b 00 00       	call   8010800e <copyuvm>
...
801045dc:	75 0c                	jne    801045ea <exit+0x24>
    panic("init exiting");
801045de:	c7 04 24 c6 85 10 80 	movl   $0x801085c6,(%esp)
...
801046bf:	e8 c3 01 00 00       	call   80104887 <sched>
  panic("zombie exit");
801046c4:	c7 04 24 d3 85 10 80 	movl   $0x801085d3,(%esp)
...
80104749:	e8 e3 37 00 00       	call   80107f31 <freevm>
        p->pid = 0;
...
80104830:	e8 24 32 00 00       	call   80107a59 <switchuvm>
      p->state = RUNNING;
...
80104852:	e8 44 0a 00 00       	call   8010529b <swtch>
      switchkvm();
80104857:	e8 e3 31 00 00       	call   80107a3f <switchkvm>
...
801048a5:	c7 04 24 df 85 10 80 	movl   $0x801085df,(%esp)
...
801048bf:	74 0c                	je     801048cd <sched+0x46>
    panic("sched locks");
801048c1:	c7 04 24 f1 85 10 80 	movl   $0x801085f1,(%esp)
...
801048d6:	75 0c                	jne    801048e4 <sched+0x5d>
    panic("sched running");
801048d8:	c7 04 24 fd 85 10 80 	movl   $0x801085fd,(%esp)
...
801048f2:	c7 04 24 0b 86 10 80 	movl   $0x8010860b,(%esp)
...
801049b8:	75 0c                	jne    801049c6 <sleep+0x20>
    panic("sleep");
801049ba:	c7 04 24 1f 86 10 80 	movl   $0x8010861f,(%esp)
...
801049cc:	c7 04 24 25 86 10 80 	movl   $0x80108625,(%esp)
...
80104b6a:	eb 07                	jmp    80104b73 <procdump+0x56>
      ...
      state = "???";
80104b6c:	c7 45 ec 36 86 10 80 	movl   $0x80108636,-0x14(%ebp)
...
80104b8e:	c7 04 24 3a 86 10 80 	movl   $0x8010863a,(%esp)
...
80104bd4:	c7 04 24 43 86 10 80 	movl   $0x80108643,(%esp)
...
80104bf3:	75 d4                	jne    80104bc9 <procdump+0xac>
    ...
    cprintf("\n");
80104bf5:	c7 04 24 47 86 10 80 	movl   $0x80108647,(%esp)
...
80104c20:	c7 44 24 04 73 86 10 	movl   $0x80108673,0x4(%esp)
80104c27:	80 
...
80104db1:	74 0c                	je     80104dbf <acquire+0x27>
    panic("acquire");
80104db3:	c7 04 24 7e 86 10 80 	movl   $0x8010867e,(%esp)
...
80104e13:	75 0c                	jne    80104e21 <release+0x21>
    panic("release");
80104e15:	c7 04 24 86 86 10 80 	movl   $0x80108686,(%esp)
...
80104f65:	c7 04 24 8e 86 10 80 	movl   $0x8010868e,(%esp)
...
80104f8d:	79 0c                	jns    80104f9b <popcli+0x4a>
    panic("popcli");
80104f8f:	c7 04 24 a5 86 10 80 	movl   $0x801086a5,(%esp)
...
8010548a:	c7 04 24 ac 86 10 80 	movl   $0x801086ac,(%esp)
...
80105920:	c7 04 24 c8 86 10 80 	movl   $0x801086c8,(%esp)
...
801059ba:	c7 44 24 04 da 86 10 	movl   $0x801086da,0x4(%esp)
801059c1:	80 
...
801059d5:	c7 44 24 04 dc 86 10 	movl   $0x801086dc,0x4(%esp)
801059dc:	80 
...
80105a2e:	c7 04 24 df 86 10 80 	movl   $0x801086df,(%esp)
...
80105aa5:	74 0c                	je     80105ab3 <sys_unlink+0x15a>
    panic("unlink: writei");
80105aa7:	c7 04 24 f1 86 10 80 	movl   $0x801086f1,(%esp)
...
80105c01:	75 0c                	jne    80105c0f <create+0xde>
    panic("create: ialloc");
80105c03:	c7 04 24 00 87 10 80 	movl   $0x80108700,(%esp)
...
80105c71:	c7 44 24 04 da 86 10 	movl   $0x801086da,0x4(%esp)
80105c78:	80 
...
80105c92:	c7 44 24 04 dc 86 10 	movl   $0x801086dc,0x4(%esp)
80105c99:	80 
...
80105ca7:	79 0c                	jns    80105cb5 <create+0x184>
      panic("create dots");
80105ca9:	c7 04 24 0f 87 10 80 	movl   $0x8010870f,(%esp)
...
80105cd5:	c7 04 24 1b 87 10 80 	movl   $0x8010871b,(%esp)
...
801063a3:	83 ec 18             	sub    $0x18,%esp
  cprintf("hello world!\n");
801063a6:	c7 04 24 2b 87 10 80 	movl   $0x8010872b,(%esp)
...
801063d7:	75 0a                	jne    801063e3 <sys_fkc+0x2a>
  {
    numForks = 0;
801063d9:	c7 05 24 b6 10 80 00 	movl   $0x0,0x8010b624
801063e0:	00 00 00 
  }
  return numForks;
801063e3:	a1 24 b6 10 80       	mov    0x8010b624,%eax
}
801063e8:	c9                   	leave  
801063e9:	c3                   	ret    
...
801063f9:	54                   	push   %esp
  call trap
801063fa:	e8 d8 01 00 00       	call   801065d7 <trap>
  addl $4, %esp
...
80106416:	83 e8 01             	sub    $0x1,%eax
80106419:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010641d:	8b 45 08             	mov    0x8(%ebp),%eax
80106420:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106424:	8b 45 08             	mov    0x8(%ebp),%eax
80106427:	c1 e8 10             	shr    $0x10,%eax
8010642a:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
8010642e:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106431:	0f 01 18             	lidtl  (%eax)
}
80106434:	c9                   	leave  
80106435:	c3                   	ret    
...
80106439:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
8010643c:	0f 20 d0             	mov    %cr2,%eax
8010643f:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
80106442:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80106445:	c9                   	leave  
80106446:	c3                   	ret    
...
8010644a:	83 ec 28             	sub    $0x28,%esp
  int i;

  for(i = 0; i < 256; i++)
8010644d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106454:	e9 c3 00 00 00       	jmp    8010651c <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106459:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010645c:	8b 04 85 80 b0 10 80 	mov    -0x7fef4f80(,%eax,4),%eax
80106463:	89 c2                	mov    %eax,%edx
80106465:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106468:	66 89 14 c5 20 5d 11 	mov    %dx,-0x7feea2e0(,%eax,8)
8010646f:	80 
80106470:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106473:	66 c7 04 c5 22 5d 11 	movw   $0x8,-0x7feea2de(,%eax,8)
8010647a:	80 08 00 
8010647d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106480:	0f b6 14 c5 24 5d 11 	movzbl -0x7feea2dc(,%eax,8),%edx
80106487:	80 
80106488:	83 e2 e0             	and    $0xffffffe0,%edx
8010648b:	88 14 c5 24 5d 11 80 	mov    %dl,-0x7feea2dc(,%eax,8)
80106492:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106495:	0f b6 14 c5 24 5d 11 	movzbl -0x7feea2dc(,%eax,8),%edx
8010649c:	80 
8010649d:	83 e2 1f             	and    $0x1f,%edx
801064a0:	88 14 c5 24 5d 11 80 	mov    %dl,-0x7feea2dc(,%eax,8)
801064a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064aa:	0f b6 14 c5 25 5d 11 	movzbl -0x7feea2db(,%eax,8),%edx
801064b1:	80 
801064b2:	83 e2 f0             	and    $0xfffffff0,%edx
801064b5:	83 ca 0e             	or     $0xe,%edx
801064b8:	88 14 c5 25 5d 11 80 	mov    %dl,-0x7feea2db(,%eax,8)
801064bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064c2:	0f b6 14 c5 25 5d 11 	movzbl -0x7feea2db(,%eax,8),%edx
801064c9:	80 
801064ca:	83 e2 ef             	and    $0xffffffef,%edx
801064cd:	88 14 c5 25 5d 11 80 	mov    %dl,-0x7feea2db(,%eax,8)
801064d4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064d7:	0f b6 14 c5 25 5d 11 	movzbl -0x7feea2db(,%eax,8),%edx
801064de:	80 
801064df:	83 e2 9f             	and    $0xffffff9f,%edx
801064e2:	88 14 c5 25 5d 11 80 	mov    %dl,-0x7feea2db(,%eax,8)
801064e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064ec:	0f b6 14 c5 25 5d 11 	movzbl -0x7feea2db(,%eax,8),%edx
801064f3:	80 
801064f4:	83 ca 80             	or     $0xffffff80,%edx
801064f7:	88 14 c5 25 5d 11 80 	mov    %dl,-0x7feea2db(,%eax,8)
801064fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106501:	8b 04 85 80 b0 10 80 	mov    -0x7fef4f80(,%eax,4),%eax
80106508:	c1 e8 10             	shr    $0x10,%eax
8010650b:	89 c2                	mov    %eax,%edx
8010650d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106510:	66 89 14 c5 26 5d 11 	mov    %dx,-0x7feea2da(,%eax,8)
80106517:	80 
  for(i = 0; i < 256; i++)
80106518:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010651c:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106523:	0f 8e 30 ff ff ff    	jle    80106459 <tvinit+0x12>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106529:	a1 80 b1 10 80       	mov    0x8010b180,%eax
8010652e:	66 a3 20 5f 11 80    	mov    %ax,0x80115f20
80106534:	66 c7 05 22 5f 11 80 	movw   $0x8,0x80115f22
8010653b:	08 00 
8010653d:	0f b6 05 24 5f 11 80 	movzbl 0x80115f24,%eax
80106544:	83 e0 e0             	and    $0xffffffe0,%eax
80106547:	a2 24 5f 11 80       	mov    %al,0x80115f24
8010654c:	0f b6 05 24 5f 11 80 	movzbl 0x80115f24,%eax
80106553:	83 e0 1f             	and    $0x1f,%eax
80106556:	a2 24 5f 11 80       	mov    %al,0x80115f24
8010655b:	0f b6 05 25 5f 11 80 	movzbl 0x80115f25,%eax
80106562:	83 c8 0f             	or     $0xf,%eax
80106565:	a2 25 5f 11 80       	mov    %al,0x80115f25
8010656a:	0f b6 05 25 5f 11 80 	movzbl 0x80115f25,%eax
80106571:	83 e0 ef             	and    $0xffffffef,%eax
80106574:	a2 25 5f 11 80       	mov    %al,0x80115f25
80106579:	0f b6 05 25 5f 11 80 	movzbl 0x80115f25,%eax
80106580:	83 c8 60             	or     $0x60,%eax
80106583:	a2 25 5f 11 80       	mov    %al,0x80115f25
80106588:	0f b6 05 25 5f 11 80 	movzbl 0x80115f25,%eax
8010658f:	83 c8 80             	or     $0xffffff80,%eax
80106592:	a2 25 5f 11 80       	mov    %al,0x80115f25
80106597:	a1 80 b1 10 80       	mov    0x8010b180,%eax
8010659c:	c1 e8 10             	shr    $0x10,%eax
8010659f:	66 a3 26 5f 11 80    	mov    %ax,0x80115f26

  initlock(&tickslock, "time");
801065a5:	c7 44 24 04 3c 87 10 	movl   $0x8010873c,0x4(%esp)
801065ac:	80 
801065ad:	c7 04 24 e0 5c 11 80 	movl   $0x80115ce0,(%esp)
801065b4:	e8 be e7 ff ff       	call   80104d77 <initlock>
}
801065b9:	c9                   	leave  
801065ba:	c3                   	ret    
...
801065be:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
801065c1:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
801065c8:	00 
801065c9:	c7 04 24 20 5d 11 80 	movl   $0x80115d20,(%esp)
801065d0:	e8 38 fe ff ff       	call   8010640d <lidt>
}
801065d5:	c9                   	leave  
801065d6:	c3                   	ret    
...
801065dd:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
801065e0:	8b 45 08             	mov    0x8(%ebp),%eax
801065e3:	8b 40 30             	mov    0x30(%eax),%eax
801065e6:	83 f8 40             	cmp    $0x40,%eax
801065e9:	75 3c                	jne    80106627 <trap+0x50>
    if(myproc()->killed)
801065eb:	e8 71 db ff ff       	call   80104161 <myproc>
801065f0:	8b 40 24             	mov    0x24(%eax),%eax
801065f3:	85 c0                	test   %eax,%eax
801065f5:	74 05                	je     801065fc <trap+0x25>
      exit();
801065f7:	e8 ca df ff ff       	call   801045c6 <exit>
    myproc()->tf = tf;
801065fc:	e8 60 db ff ff       	call   80104161 <myproc>
80106601:	8b 55 08             	mov    0x8(%ebp),%edx
80106604:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80106607:	e8 15 ee ff ff       	call   80105421 <syscall>
    if(myproc()->killed)
8010660c:	e8 50 db ff ff       	call   80104161 <myproc>
80106611:	8b 40 24             	mov    0x24(%eax),%eax
80106614:	85 c0                	test   %eax,%eax
80106616:	74 0a                	je     80106622 <trap+0x4b>
      exit();
80106618:	e8 a9 df ff ff       	call   801045c6 <exit>
    return;
8010661d:	e9 19 02 00 00       	jmp    8010683b <trap+0x264>
80106622:	e9 14 02 00 00       	jmp    8010683b <trap+0x264>
  }

  switch(tf->trapno){
80106627:	8b 45 08             	mov    0x8(%ebp),%eax
8010662a:	8b 40 30             	mov    0x30(%eax),%eax
8010662d:	83 e8 20             	sub    $0x20,%eax
80106630:	83 f8 1f             	cmp    $0x1f,%eax
80106633:	0f 87 b1 00 00 00    	ja     801066ea <trap+0x113>
80106639:	8b 04 85 e4 87 10 80 	mov    -0x7fef781c(,%eax,4),%eax
80106640:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80106642:	e8 83 da ff ff       	call   801040ca <cpuid>
80106647:	85 c0                	test   %eax,%eax
80106649:	75 31                	jne    8010667c <trap+0xa5>
      acquire(&tickslock);
8010664b:	c7 04 24 e0 5c 11 80 	movl   $0x80115ce0,(%esp)
80106652:	e8 41 e7 ff ff       	call   80104d98 <acquire>
      ticks++;
80106657:	a1 20 65 11 80       	mov    0x80116520,%eax
8010665c:	83 c0 01             	add    $0x1,%eax
8010665f:	a3 20 65 11 80       	mov    %eax,0x80116520
      wakeup(&ticks);
80106664:	c7 04 24 20 65 11 80 	movl   $0x80116520,(%esp)
8010666b:	e8 0a e4 ff ff       	call   80104a7a <wakeup>
      release(&tickslock);
80106670:	c7 04 24 e0 5c 11 80 	movl   $0x80115ce0,(%esp)
80106677:	e8 84 e7 ff ff       	call   80104e00 <release>
    }
    lapiceoi();
8010667c:	e8 d0 c8 ff ff       	call   80102f51 <lapiceoi>
    break;
80106681:	e9 37 01 00 00       	jmp    801067bd <trap+0x1e6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106686:	e8 3d c1 ff ff       	call   801027c8 <ideintr>
    lapiceoi();
8010668b:	e8 c1 c8 ff ff       	call   80102f51 <lapiceoi>
    break;
80106690:	e9 28 01 00 00       	jmp    801067bd <trap+0x1e6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106695:	e8 cc c6 ff ff       	call   80102d66 <kbdintr>
    lapiceoi();
8010669a:	e8 b2 c8 ff ff       	call   80102f51 <lapiceoi>
    break;
8010669f:	e9 19 01 00 00       	jmp    801067bd <trap+0x1e6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
801066a4:	e8 7b 03 00 00       	call   80106a24 <uartintr>
    lapiceoi();
801066a9:	e8 a3 c8 ff ff       	call   80102f51 <lapiceoi>
    break;
801066ae:	e9 0a 01 00 00       	jmp    801067bd <trap+0x1e6>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801066b3:	8b 45 08             	mov    0x8(%ebp),%eax
801066b6:	8b 70 38             	mov    0x38(%eax),%esi
            cpuid(), tf->cs, tf->eip);
801066b9:	8b 45 08             	mov    0x8(%ebp),%eax
801066bc:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801066c0:	0f b7 d8             	movzwl %ax,%ebx
801066c3:	e8 02 da ff ff       	call   801040ca <cpuid>
801066c8:	89 74 24 0c          	mov    %esi,0xc(%esp)
801066cc:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801066d0:	89 44 24 04          	mov    %eax,0x4(%esp)
801066d4:	c7 04 24 44 87 10 80 	movl   $0x80108744,(%esp)
801066db:	e8 e8 9c ff ff       	call   801003c8 <cprintf>
    lapiceoi();
801066e0:	e8 6c c8 ff ff       	call   80102f51 <lapiceoi>
    break;
801066e5:	e9 d3 00 00 00       	jmp    801067bd <trap+0x1e6>

  //PAGEBREAK: 13
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
801066ea:	e8 72 da ff ff       	call   80104161 <myproc>
801066ef:	85 c0                	test   %eax,%eax
801066f1:	74 11                	je     80106704 <trap+0x12d>
...
80106702:	75 40                	jne    80106744 <trap+0x16d>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106704:	e8 2d fd ff ff       	call   80106436 <rcr2>
80106709:	89 c3                	mov    %eax,%ebx
8010670b:	8b 45 08             	mov    0x8(%ebp),%eax
8010670e:	8b 70 38             	mov    0x38(%eax),%esi
80106711:	e8 b4 d9 ff ff       	call   801040ca <cpuid>
80106716:	8b 55 08             	mov    0x8(%ebp),%edx
80106719:	8b 52 30             	mov    0x30(%edx),%edx
8010671c:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106720:	89 74 24 0c          	mov    %esi,0xc(%esp)
80106724:	89 44 24 08          	mov    %eax,0x8(%esp)
80106728:	89 54 24 04          	mov    %edx,0x4(%esp)
8010672c:	c7 04 24 68 87 10 80 	movl   $0x80108768,(%esp)
80106733:	e8 90 9c ff ff       	call   801003c8 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80106738:	c7 04 24 9a 87 10 80 	movl   $0x8010879a,(%esp)
8010673f:	e8 1e 9e ff ff       	call   80100562 <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106744:	e8 ed fc ff ff       	call   80106436 <rcr2>
80106749:	89 c6                	mov    %eax,%esi
8010674b:	8b 45 08             	mov    0x8(%ebp),%eax
8010674e:	8b 40 38             	mov    0x38(%eax),%eax
80106751:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106754:	e8 71 d9 ff ff       	call   801040ca <cpuid>
80106759:	89 c3                	mov    %eax,%ebx
8010675b:	8b 45 08             	mov    0x8(%ebp),%eax
8010675e:	8b 78 34             	mov    0x34(%eax),%edi
80106761:	89 7d e0             	mov    %edi,-0x20(%ebp)
80106764:	8b 45 08             	mov    0x8(%ebp),%eax
80106767:	8b 78 30             	mov    0x30(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
8010676a:	e8 f2 d9 ff ff       	call   80104161 <myproc>
8010676f:	8d 50 6c             	lea    0x6c(%eax),%edx
80106772:	89 55 dc             	mov    %edx,-0x24(%ebp)
80106775:	e8 e7 d9 ff ff       	call   80104161 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010677a:	8b 40 10             	mov    0x10(%eax),%eax
8010677d:	89 74 24 1c          	mov    %esi,0x1c(%esp)
80106781:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106784:	89 4c 24 18          	mov    %ecx,0x18(%esp)
80106788:	89 5c 24 14          	mov    %ebx,0x14(%esp)
8010678c:	8b 4d e0             	mov    -0x20(%ebp),%ecx
8010678f:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80106793:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80106797:	8b 55 dc             	mov    -0x24(%ebp),%edx
8010679a:	89 54 24 08          	mov    %edx,0x8(%esp)
8010679e:	89 44 24 04          	mov    %eax,0x4(%esp)
801067a2:	c7 04 24 a0 87 10 80 	movl   $0x801087a0,(%esp)
801067a9:	e8 1a 9c ff ff       	call   801003c8 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801067ae:	e8 ae d9 ff ff       	call   80104161 <myproc>
801067b3:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801067ba:	eb 01                	jmp    801067bd <trap+0x1e6>
    break;
801067bc:	90                   	nop
  }
...
801067bd:	e8 9f d9 ff ff       	call   80104161 <myproc>
801067c2:	85 c0                	test   %eax,%eax
801067c4:	74 23                	je     801067e9 <trap+0x212>
801067c6:	e8 96 d9 ff ff       	call   80104161 <myproc>
801067cb:	8b 40 24             	mov    0x24(%eax),%eax
801067ce:	85 c0                	test   %eax,%eax
801067d0:	74 17                	je     801067e9 <trap+0x212>
801067d2:	8b 45 08             	mov    0x8(%ebp),%eax
801067d5:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801067d9:	0f b7 c0             	movzwl %ax,%eax
801067dc:	83 e0 03             	and    $0x3,%eax
801067df:	83 f8 03             	cmp    $0x3,%eax
801067e2:	75 05                	jne    801067e9 <trap+0x212>
    exit();
801067e4:	e8 dd dd ff ff       	call   801045c6 <exit>

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
801067e9:	e8 73 d9 ff ff       	call   80104161 <myproc>
801067ee:	85 c0                	test   %eax,%eax
801067f0:	74 1d                	je     8010680f <trap+0x238>
801067f2:	e8 6a d9 ff ff       	call   80104161 <myproc>
801067f7:	8b 40 0c             	mov    0xc(%eax),%eax
801067fa:	83 f8 04             	cmp    $0x4,%eax
801067fd:	75 10                	jne    8010680f <trap+0x238>
     tf->trapno == T_IRQ0+IRQ_TIMER)
801067ff:	8b 45 08             	mov    0x8(%ebp),%eax
80106802:	8b 40 30             	mov    0x30(%eax),%eax
  if(myproc() && myproc()->state == RUNNING &&
80106805:	83 f8 20             	cmp    $0x20,%eax
80106808:	75 05                	jne    8010680f <trap+0x238>
    yield();
8010680a:	e8 27 e1 ff ff       	call   80104936 <yield>

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010680f:	e8 4d d9 ff ff       	call   80104161 <myproc>
80106814:	85 c0                	test   %eax,%eax
80106816:	74 23                	je     8010683b <trap+0x264>
80106818:	e8 44 d9 ff ff       	call   80104161 <myproc>
8010681d:	8b 40 24             	mov    0x24(%eax),%eax
80106820:	85 c0                	test   %eax,%eax
80106822:	74 17                	je     8010683b <trap+0x264>
...
80106834:	75 05                	jne    8010683b <trap+0x264>
    exit();
80106836:	e8 8b dd ff ff       	call   801045c6 <exit>
}
8010683b:	83 c4 3c             	add    $0x3c,%esp
8010683e:	5b                   	pop    %ebx
8010683f:	5e                   	pop    %esi
80106840:	5f                   	pop    %edi
80106841:	5d                   	pop    %ebp
...
8010684c:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106850:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
80106854:	89 c2                	mov    %eax,%edx
80106856:	ec                   	in     (%dx),%al
80106857:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
8010685a:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
8010685e:	c9                   	leave  
8010685f:	c3                   	ret    
...
8010686c:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106870:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106873:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106877:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
8010687b:	ee                   	out    %al,(%dx)
}
8010687c:	c9                   	leave  
8010687d:	c3                   	ret    
...
80106881:	83 ec 28             	sub    $0x28,%esp
  char *p;
...
80106893:	e8 c8 ff ff ff       	call   80106860 <outb>

  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106898:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
8010689f:	00 
801068a0:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801068a7:	e8 b4 ff ff ff       	call   80106860 <outb>
  outb(COM1+0, 115200/9600);
801068ac:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
801068b3:	00 
801068b4:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801068bb:	e8 a0 ff ff ff       	call   80106860 <outb>
  outb(COM1+1, 0);
801068c0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801068c7:	00 
801068c8:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801068cf:	e8 8c ff ff ff       	call   80106860 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
801068d4:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801068db:	00 
801068dc:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801068e3:	e8 78 ff ff ff       	call   80106860 <outb>
  outb(COM1+4, 0);
801068e8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801068ef:	00 
801068f0:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
801068f7:	e8 64 ff ff ff       	call   80106860 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
801068fc:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106903:	00 
80106904:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
8010690b:	e8 50 ff ff ff       	call   80106860 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106910:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106917:	e8 27 ff ff ff       	call   80106843 <inb>
8010691c:	3c ff                	cmp    $0xff,%al
8010691e:	75 02                	jne    80106922 <uartinit+0xa4>
    return;
80106920:	eb 5e                	jmp    80106980 <uartinit+0x102>
  uart = 1;
80106922:	c7 05 28 b6 10 80 01 	movl   $0x1,0x8010b628
80106929:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
8010692c:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106933:	e8 0b ff ff ff       	call   80106843 <inb>
  inb(COM1+0);
80106938:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010693f:	e8 ff fe ff ff       	call   80106843 <inb>
  ioapicenable(IRQ_COM1, 0);
80106944:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010694b:	00 
8010694c:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106953:	e8 e7 c0 ff ff       	call   80102a3f <ioapicenable>

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106958:	c7 45 f4 64 88 10 80 	movl   $0x80108864,-0xc(%ebp)
8010695f:	eb 15                	jmp    80106976 <uartinit+0xf8>
    uartputc(*p);
80106961:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106964:	0f b6 00             	movzbl (%eax),%eax
80106967:	0f be c0             	movsbl %al,%eax
8010696a:	89 04 24             	mov    %eax,(%esp)
8010696d:	e8 10 00 00 00       	call   80106982 <uartputc>
  for(p="xv6...\n"; *p; p++)
80106972:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106976:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106979:	0f b6 00             	movzbl (%eax),%eax
8010697c:	84 c0                	test   %al,%al
8010697e:	75 e1                	jne    80106961 <uartinit+0xe3>
}
80106980:	c9                   	leave  
80106981:	c3                   	ret    
...
80106985:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
80106988:	a1 28 b6 10 80       	mov    0x8010b628,%eax
8010698d:	85 c0                	test   %eax,%eax
8010698f:	75 02                	jne    80106993 <uartputc+0x11>
    return;
80106991:	eb 4b                	jmp    801069de <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106993:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010699a:	eb 10                	jmp    801069ac <uartputc+0x2a>
    microdelay(10);
8010699c:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
801069a3:	e8 ce c5 ff ff       	call   80102f76 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801069a8:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801069ac:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
801069b0:	7f 16                	jg     801069c8 <uartputc+0x46>
801069b2:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801069b9:	e8 85 fe ff ff       	call   80106843 <inb>
801069be:	0f b6 c0             	movzbl %al,%eax
801069c1:	83 e0 20             	and    $0x20,%eax
801069c4:	85 c0                	test   %eax,%eax
801069c6:	74 d4                	je     8010699c <uartputc+0x1a>
  outb(COM1+0, c);
801069c8:	8b 45 08             	mov    0x8(%ebp),%eax
801069cb:	0f b6 c0             	movzbl %al,%eax
801069ce:	89 44 24 04          	mov    %eax,0x4(%esp)
801069d2:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801069d9:	e8 82 fe ff ff       	call   80106860 <outb>
}
801069de:	c9                   	leave  
801069df:	c3                   	ret    
...
801069e3:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
801069e6:	a1 28 b6 10 80       	mov    0x8010b628,%eax
801069eb:	85 c0                	test   %eax,%eax
801069ed:	75 07                	jne    801069f6 <uartgetc+0x16>
    return -1;
801069ef:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069f4:	eb 2c                	jmp    80106a22 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
801069f6:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801069fd:	e8 41 fe ff ff       	call   80106843 <inb>
80106a02:	0f b6 c0             	movzbl %al,%eax
80106a05:	83 e0 01             	and    $0x1,%eax
80106a08:	85 c0                	test   %eax,%eax
80106a0a:	75 07                	jne    80106a13 <uartgetc+0x33>
    return -1;
80106a0c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a11:	eb 0f                	jmp    80106a22 <uartgetc+0x42>
  return inb(COM1+0);
80106a13:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106a1a:	e8 24 fe ff ff       	call   80106843 <inb>
...
80106a27:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
80106a2a:	c7 04 24 e0 69 10 80 	movl   $0x801069e0,(%esp)
80106a31:	e8 b3 9d ff ff       	call   801007e9 <consoleintr>
}
80106a36:	c9                   	leave  
80106a37:	c3                   	ret    
...
vector8:
  pushl $8
80106a80:	6a 08                	push   $0x8
  jmp alltraps
80106a82:	e9 63 f9 ff ff       	jmp    801063ea <alltraps>
...
80106a87:	6a 00                	push   $0x0
  pushl $9
80106a89:	6a 09                	push   $0x9
  jmp alltraps
80106a8b:	e9 5a f9 ff ff       	jmp    801063ea <alltraps>
...
80106a90:	6a 0a                	push   $0xa
  jmp alltraps
80106a92:	e9 53 f9 ff ff       	jmp    801063ea <alltraps>

80106a97 <vector11>:
.globl vector11
vector11:
  pushl $11
80106a97:	6a 0b                	push   $0xb
  jmp alltraps
80106a99:	e9 4c f9 ff ff       	jmp    801063ea <alltraps>

80106a9e <vector12>:
.globl vector12
vector12:
  pushl $12
80106a9e:	6a 0c                	push   $0xc
  jmp alltraps
80106aa0:	e9 45 f9 ff ff       	jmp    801063ea <alltraps>

80106aa5 <vector13>:
.globl vector13
vector13:
  pushl $13
80106aa5:	6a 0d                	push   $0xd
  jmp alltraps
80106aa7:	e9 3e f9 ff ff       	jmp    801063ea <alltraps>

80106aac <vector14>:
.globl vector14
vector14:
  pushl $14
80106aac:	6a 0e                	push   $0xe
  jmp alltraps
80106aae:	e9 37 f9 ff ff       	jmp    801063ea <alltraps>
...
80106ab3:	6a 00                	push   $0x0
  pushl $15
80106ab5:	6a 0f                	push   $0xf
  jmp alltraps
80106ab7:	e9 2e f9 ff ff       	jmp    801063ea <alltraps>
...
80106abc:	6a 00                	push   $0x0
  pushl $16
80106abe:	6a 10                	push   $0x10
  jmp alltraps
80106ac0:	e9 25 f9 ff ff       	jmp    801063ea <alltraps>

80106ac5 <vector17>:
.globl vector17
vector17:
  pushl $17
80106ac5:	6a 11                	push   $0x11
  jmp alltraps
80106ac7:	e9 1e f9 ff ff       	jmp    801063ea <alltraps>
...
80106acc:	6a 00                	push   $0x0
  pushl $18
80106ace:	6a 12                	push   $0x12
  jmp alltraps
80106ad0:	e9 15 f9 ff ff       	jmp    801063ea <alltraps>
...
80106ad5:	6a 00                	push   $0x0
  pushl $19
80106ad7:	6a 13                	push   $0x13
  jmp alltraps
80106ad9:	e9 0c f9 ff ff       	jmp    801063ea <alltraps>
...
80106ade:	6a 00                	push   $0x0
  pushl $20
80106ae0:	6a 14                	push   $0x14
  jmp alltraps
80106ae2:	e9 03 f9 ff ff       	jmp    801063ea <alltraps>
...
80106ae7:	6a 00                	push   $0x0
  pushl $21
80106ae9:	6a 15                	push   $0x15
  jmp alltraps
80106aeb:	e9 fa f8 ff ff       	jmp    801063ea <alltraps>
...
80106af0:	6a 00                	push   $0x0
  pushl $22
80106af2:	6a 16                	push   $0x16
  jmp alltraps
80106af4:	e9 f1 f8 ff ff       	jmp    801063ea <alltraps>
...
80106af9:	6a 00                	push   $0x0
  pushl $23
80106afb:	6a 17                	push   $0x17
  jmp alltraps
80106afd:	e9 e8 f8 ff ff       	jmp    801063ea <alltraps>
...
80106b02:	6a 00                	push   $0x0
  pushl $24
80106b04:	6a 18                	push   $0x18
  jmp alltraps
80106b06:	e9 df f8 ff ff       	jmp    801063ea <alltraps>
...
80106b0b:	6a 00                	push   $0x0
  pushl $25
80106b0d:	6a 19                	push   $0x19
  jmp alltraps
80106b0f:	e9 d6 f8 ff ff       	jmp    801063ea <alltraps>
...
80106b14:	6a 00                	push   $0x0
  pushl $26
80106b16:	6a 1a                	push   $0x1a
  jmp alltraps
80106b18:	e9 cd f8 ff ff       	jmp    801063ea <alltraps>
...
80106b1d:	6a 00                	push   $0x0
  pushl $27
80106b1f:	6a 1b                	push   $0x1b
  jmp alltraps
80106b21:	e9 c4 f8 ff ff       	jmp    801063ea <alltraps>
...
80106b26:	6a 00                	push   $0x0
  pushl $28
80106b28:	6a 1c                	push   $0x1c
  jmp alltraps
80106b2a:	e9 bb f8 ff ff       	jmp    801063ea <alltraps>
...
80106b2f:	6a 00                	push   $0x0
  pushl $29
80106b31:	6a 1d                	push   $0x1d
  jmp alltraps
80106b33:	e9 b2 f8 ff ff       	jmp    801063ea <alltraps>
...
80106b38:	6a 00                	push   $0x0
  pushl $30
80106b3a:	6a 1e                	push   $0x1e
  jmp alltraps
80106b3c:	e9 a9 f8 ff ff       	jmp    801063ea <alltraps>
...
80106b41:	6a 00                	push   $0x0
  pushl $31
80106b43:	6a 1f                	push   $0x1f
  jmp alltraps
80106b45:	e9 a0 f8 ff ff       	jmp    801063ea <alltraps>
...
80106b4a:	6a 00                	push   $0x0
  pushl $32
80106b4c:	6a 20                	push   $0x20
  jmp alltraps
80106b4e:	e9 97 f8 ff ff       	jmp    801063ea <alltraps>
...
80106b53:	6a 00                	push   $0x0
  pushl $33
80106b55:	6a 21                	push   $0x21
  jmp alltraps
80106b57:	e9 8e f8 ff ff       	jmp    801063ea <alltraps>
...
80106b5c:	6a 00                	push   $0x0
  pushl $34
80106b5e:	6a 22                	push   $0x22
  jmp alltraps
80106b60:	e9 85 f8 ff ff       	jmp    801063ea <alltraps>
...
80106b65:	6a 00                	push   $0x0
  pushl $35
80106b67:	6a 23                	push   $0x23
  jmp alltraps
80106b69:	e9 7c f8 ff ff       	jmp    801063ea <alltraps>
...
80106b6e:	6a 00                	push   $0x0
  pushl $36
80106b70:	6a 24                	push   $0x24
  jmp alltraps
80106b72:	e9 73 f8 ff ff       	jmp    801063ea <alltraps>
...
80106b77:	6a 00                	push   $0x0
  pushl $37
80106b79:	6a 25                	push   $0x25
  jmp alltraps
80106b7b:	e9 6a f8 ff ff       	jmp    801063ea <alltraps>
...
80106b80:	6a 00                	push   $0x0
  pushl $38
80106b82:	6a 26                	push   $0x26
  jmp alltraps
80106b84:	e9 61 f8 ff ff       	jmp    801063ea <alltraps>
...
80106b89:	6a 00                	push   $0x0
  pushl $39
80106b8b:	6a 27                	push   $0x27
  jmp alltraps
80106b8d:	e9 58 f8 ff ff       	jmp    801063ea <alltraps>
...
80106b92:	6a 00                	push   $0x0
  pushl $40
80106b94:	6a 28                	push   $0x28
  jmp alltraps
80106b96:	e9 4f f8 ff ff       	jmp    801063ea <alltraps>
...
80106b9b:	6a 00                	push   $0x0
  pushl $41
80106b9d:	6a 29                	push   $0x29
  jmp alltraps
80106b9f:	e9 46 f8 ff ff       	jmp    801063ea <alltraps>
...
80106ba4:	6a 00                	push   $0x0
  pushl $42
80106ba6:	6a 2a                	push   $0x2a
  jmp alltraps
80106ba8:	e9 3d f8 ff ff       	jmp    801063ea <alltraps>
...
80106bad:	6a 00                	push   $0x0
  pushl $43
80106baf:	6a 2b                	push   $0x2b
  jmp alltraps
80106bb1:	e9 34 f8 ff ff       	jmp    801063ea <alltraps>
...
80106bb6:	6a 00                	push   $0x0
  pushl $44
80106bb8:	6a 2c                	push   $0x2c
  jmp alltraps
80106bba:	e9 2b f8 ff ff       	jmp    801063ea <alltraps>
...
80106bbf:	6a 00                	push   $0x0
  pushl $45
80106bc1:	6a 2d                	push   $0x2d
  jmp alltraps
80106bc3:	e9 22 f8 ff ff       	jmp    801063ea <alltraps>
...
80106bc8:	6a 00                	push   $0x0
  pushl $46
80106bca:	6a 2e                	push   $0x2e
  jmp alltraps
80106bcc:	e9 19 f8 ff ff       	jmp    801063ea <alltraps>
...
80106bd1:	6a 00                	push   $0x0
  pushl $47
80106bd3:	6a 2f                	push   $0x2f
  jmp alltraps
80106bd5:	e9 10 f8 ff ff       	jmp    801063ea <alltraps>
...
80106bda:	6a 00                	push   $0x0
  pushl $48
80106bdc:	6a 30                	push   $0x30
  jmp alltraps
80106bde:	e9 07 f8 ff ff       	jmp    801063ea <alltraps>
...
80106be3:	6a 00                	push   $0x0
  pushl $49
80106be5:	6a 31                	push   $0x31
  jmp alltraps
80106be7:	e9 fe f7 ff ff       	jmp    801063ea <alltraps>
...
80106bec:	6a 00                	push   $0x0
  pushl $50
80106bee:	6a 32                	push   $0x32
  jmp alltraps
80106bf0:	e9 f5 f7 ff ff       	jmp    801063ea <alltraps>
...
80106bf5:	6a 00                	push   $0x0
  pushl $51
80106bf7:	6a 33                	push   $0x33
  jmp alltraps
80106bf9:	e9 ec f7 ff ff       	jmp    801063ea <alltraps>
...
80106bfe:	6a 00                	push   $0x0
  pushl $52
80106c00:	6a 34                	push   $0x34
  jmp alltraps
80106c02:	e9 e3 f7 ff ff       	jmp    801063ea <alltraps>
...
80106c07:	6a 00                	push   $0x0
  pushl $53
80106c09:	6a 35                	push   $0x35
  jmp alltraps
80106c0b:	e9 da f7 ff ff       	jmp    801063ea <alltraps>
...
80106c10:	6a 00                	push   $0x0
  pushl $54
80106c12:	6a 36                	push   $0x36
  jmp alltraps
80106c14:	e9 d1 f7 ff ff       	jmp    801063ea <alltraps>
...
80106c19:	6a 00                	push   $0x0
  pushl $55
80106c1b:	6a 37                	push   $0x37
  jmp alltraps
80106c1d:	e9 c8 f7 ff ff       	jmp    801063ea <alltraps>
...
80106c22:	6a 00                	push   $0x0
  pushl $56
80106c24:	6a 38                	push   $0x38
  jmp alltraps
80106c26:	e9 bf f7 ff ff       	jmp    801063ea <alltraps>
...
80106c2b:	6a 00                	push   $0x0
  pushl $57
80106c2d:	6a 39                	push   $0x39
  jmp alltraps
80106c2f:	e9 b6 f7 ff ff       	jmp    801063ea <alltraps>
...
80106c34:	6a 00                	push   $0x0
  pushl $58
80106c36:	6a 3a                	push   $0x3a
  jmp alltraps
80106c38:	e9 ad f7 ff ff       	jmp    801063ea <alltraps>
...
80106c3d:	6a 00                	push   $0x0
  pushl $59
80106c3f:	6a 3b                	push   $0x3b
  jmp alltraps
80106c41:	e9 a4 f7 ff ff       	jmp    801063ea <alltraps>
...
80106c46:	6a 00                	push   $0x0
  pushl $60
80106c48:	6a 3c                	push   $0x3c
  jmp alltraps
80106c4a:	e9 9b f7 ff ff       	jmp    801063ea <alltraps>
...
80106c4f:	6a 00                	push   $0x0
  pushl $61
80106c51:	6a 3d                	push   $0x3d
  jmp alltraps
80106c53:	e9 92 f7 ff ff       	jmp    801063ea <alltraps>
...
80106c58:	6a 00                	push   $0x0
  pushl $62
80106c5a:	6a 3e                	push   $0x3e
  jmp alltraps
80106c5c:	e9 89 f7 ff ff       	jmp    801063ea <alltraps>
...
80106c61:	6a 00                	push   $0x0
  pushl $63
80106c63:	6a 3f                	push   $0x3f
  jmp alltraps
80106c65:	e9 80 f7 ff ff       	jmp    801063ea <alltraps>
...
80106c6a:	6a 00                	push   $0x0
  pushl $64
80106c6c:	6a 40                	push   $0x40
  jmp alltraps
80106c6e:	e9 77 f7 ff ff       	jmp    801063ea <alltraps>
...
80106c73:	6a 00                	push   $0x0
  pushl $65
80106c75:	6a 41                	push   $0x41
  jmp alltraps
80106c77:	e9 6e f7 ff ff       	jmp    801063ea <alltraps>
...
80106c7c:	6a 00                	push   $0x0
  pushl $66
80106c7e:	6a 42                	push   $0x42
  jmp alltraps
80106c80:	e9 65 f7 ff ff       	jmp    801063ea <alltraps>
...
80106c85:	6a 00                	push   $0x0
  pushl $67
80106c87:	6a 43                	push   $0x43
  jmp alltraps
80106c89:	e9 5c f7 ff ff       	jmp    801063ea <alltraps>
...
80106c8e:	6a 00                	push   $0x0
  pushl $68
80106c90:	6a 44                	push   $0x44
  jmp alltraps
80106c92:	e9 53 f7 ff ff       	jmp    801063ea <alltraps>
...
80106c97:	6a 00                	push   $0x0
  pushl $69
80106c99:	6a 45                	push   $0x45
  jmp alltraps
80106c9b:	e9 4a f7 ff ff       	jmp    801063ea <alltraps>
...
80106ca0:	6a 00                	push   $0x0
  pushl $70
80106ca2:	6a 46                	push   $0x46
  jmp alltraps
80106ca4:	e9 41 f7 ff ff       	jmp    801063ea <alltraps>
...
80106ca9:	6a 00                	push   $0x0
  pushl $71
80106cab:	6a 47                	push   $0x47
  jmp alltraps
80106cad:	e9 38 f7 ff ff       	jmp    801063ea <alltraps>
...
80106cb2:	6a 00                	push   $0x0
  pushl $72
80106cb4:	6a 48                	push   $0x48
  jmp alltraps
80106cb6:	e9 2f f7 ff ff       	jmp    801063ea <alltraps>
...
80106cbb:	6a 00                	push   $0x0
  pushl $73
80106cbd:	6a 49                	push   $0x49
  jmp alltraps
80106cbf:	e9 26 f7 ff ff       	jmp    801063ea <alltraps>
...
80106cc4:	6a 00                	push   $0x0
  pushl $74
80106cc6:	6a 4a                	push   $0x4a
  jmp alltraps
80106cc8:	e9 1d f7 ff ff       	jmp    801063ea <alltraps>
...
80106ccd:	6a 00                	push   $0x0
  pushl $75
80106ccf:	6a 4b                	push   $0x4b
  jmp alltraps
80106cd1:	e9 14 f7 ff ff       	jmp    801063ea <alltraps>
...
80106cd6:	6a 00                	push   $0x0
  pushl $76
80106cd8:	6a 4c                	push   $0x4c
  jmp alltraps
80106cda:	e9 0b f7 ff ff       	jmp    801063ea <alltraps>
...
80106cdf:	6a 00                	push   $0x0
  pushl $77
80106ce1:	6a 4d                	push   $0x4d
  jmp alltraps
80106ce3:	e9 02 f7 ff ff       	jmp    801063ea <alltraps>
...
80106ce8:	6a 00                	push   $0x0
  pushl $78
80106cea:	6a 4e                	push   $0x4e
  jmp alltraps
80106cec:	e9 f9 f6 ff ff       	jmp    801063ea <alltraps>
...
80106cf1:	6a 00                	push   $0x0
  pushl $79
80106cf3:	6a 4f                	push   $0x4f
  jmp alltraps
80106cf5:	e9 f0 f6 ff ff       	jmp    801063ea <alltraps>
...
80106cfa:	6a 00                	push   $0x0
  pushl $80
80106cfc:	6a 50                	push   $0x50
  jmp alltraps
80106cfe:	e9 e7 f6 ff ff       	jmp    801063ea <alltraps>
...
80106d03:	6a 00                	push   $0x0
  pushl $81
80106d05:	6a 51                	push   $0x51
  jmp alltraps
80106d07:	e9 de f6 ff ff       	jmp    801063ea <alltraps>
...
80106d0c:	6a 00                	push   $0x0
  pushl $82
80106d0e:	6a 52                	push   $0x52
  jmp alltraps
80106d10:	e9 d5 f6 ff ff       	jmp    801063ea <alltraps>
...
80106d15:	6a 00                	push   $0x0
  pushl $83
80106d17:	6a 53                	push   $0x53
  jmp alltraps
80106d19:	e9 cc f6 ff ff       	jmp    801063ea <alltraps>
...
80106d1e:	6a 00                	push   $0x0
  pushl $84
80106d20:	6a 54                	push   $0x54
  jmp alltraps
80106d22:	e9 c3 f6 ff ff       	jmp    801063ea <alltraps>
...
80106d27:	6a 00                	push   $0x0
  pushl $85
80106d29:	6a 55                	push   $0x55
  jmp alltraps
80106d2b:	e9 ba f6 ff ff       	jmp    801063ea <alltraps>
...
80106d30:	6a 00                	push   $0x0
  pushl $86
80106d32:	6a 56                	push   $0x56
  jmp alltraps
80106d34:	e9 b1 f6 ff ff       	jmp    801063ea <alltraps>
...
80106d39:	6a 00                	push   $0x0
  pushl $87
80106d3b:	6a 57                	push   $0x57
  jmp alltraps
80106d3d:	e9 a8 f6 ff ff       	jmp    801063ea <alltraps>
...
80106d42:	6a 00                	push   $0x0
  pushl $88
80106d44:	6a 58                	push   $0x58
  jmp alltraps
80106d46:	e9 9f f6 ff ff       	jmp    801063ea <alltraps>
...
80106d4b:	6a 00                	push   $0x0
  pushl $89
80106d4d:	6a 59                	push   $0x59
  jmp alltraps
80106d4f:	e9 96 f6 ff ff       	jmp    801063ea <alltraps>
...
80106d54:	6a 00                	push   $0x0
  pushl $90
80106d56:	6a 5a                	push   $0x5a
  jmp alltraps
80106d58:	e9 8d f6 ff ff       	jmp    801063ea <alltraps>
...
80106d5d:	6a 00                	push   $0x0
  pushl $91
80106d5f:	6a 5b                	push   $0x5b
  jmp alltraps
80106d61:	e9 84 f6 ff ff       	jmp    801063ea <alltraps>
...
80106d66:	6a 00                	push   $0x0
  pushl $92
80106d68:	6a 5c                	push   $0x5c
  jmp alltraps
80106d6a:	e9 7b f6 ff ff       	jmp    801063ea <alltraps>
...
80106d6f:	6a 00                	push   $0x0
  pushl $93
80106d71:	6a 5d                	push   $0x5d
  jmp alltraps
80106d73:	e9 72 f6 ff ff       	jmp    801063ea <alltraps>
...
80106d78:	6a 00                	push   $0x0
  pushl $94
80106d7a:	6a 5e                	push   $0x5e
  jmp alltraps
80106d7c:	e9 69 f6 ff ff       	jmp    801063ea <alltraps>
...
80106d81:	6a 00                	push   $0x0
  pushl $95
80106d83:	6a 5f                	push   $0x5f
  jmp alltraps
80106d85:	e9 60 f6 ff ff       	jmp    801063ea <alltraps>
...
80106d8a:	6a 00                	push   $0x0
  pushl $96
80106d8c:	6a 60                	push   $0x60
  jmp alltraps
80106d8e:	e9 57 f6 ff ff       	jmp    801063ea <alltraps>
...
80106d93:	6a 00                	push   $0x0
  pushl $97
80106d95:	6a 61                	push   $0x61
  jmp alltraps
80106d97:	e9 4e f6 ff ff       	jmp    801063ea <alltraps>
...
80106d9c:	6a 00                	push   $0x0
  pushl $98
80106d9e:	6a 62                	push   $0x62
  jmp alltraps
80106da0:	e9 45 f6 ff ff       	jmp    801063ea <alltraps>
...
80106da5:	6a 00                	push   $0x0
  pushl $99
80106da7:	6a 63                	push   $0x63
  jmp alltraps
80106da9:	e9 3c f6 ff ff       	jmp    801063ea <alltraps>
...
80106dae:	6a 00                	push   $0x0
  pushl $100
80106db0:	6a 64                	push   $0x64
  jmp alltraps
80106db2:	e9 33 f6 ff ff       	jmp    801063ea <alltraps>
...
80106db7:	6a 00                	push   $0x0
  pushl $101
80106db9:	6a 65                	push   $0x65
  jmp alltraps
80106dbb:	e9 2a f6 ff ff       	jmp    801063ea <alltraps>
...
80106dc0:	6a 00                	push   $0x0
  pushl $102
80106dc2:	6a 66                	push   $0x66
  jmp alltraps
80106dc4:	e9 21 f6 ff ff       	jmp    801063ea <alltraps>
...
80106dc9:	6a 00                	push   $0x0
  pushl $103
80106dcb:	6a 67                	push   $0x67
  jmp alltraps
80106dcd:	e9 18 f6 ff ff       	jmp    801063ea <alltraps>
...
80106dd2:	6a 00                	push   $0x0
  pushl $104
80106dd4:	6a 68                	push   $0x68
  jmp alltraps
80106dd6:	e9 0f f6 ff ff       	jmp    801063ea <alltraps>
...
80106ddb:	6a 00                	push   $0x0
  pushl $105
80106ddd:	6a 69                	push   $0x69
  jmp alltraps
80106ddf:	e9 06 f6 ff ff       	jmp    801063ea <alltraps>
...
80106de4:	6a 00                	push   $0x0
  pushl $106
80106de6:	6a 6a                	push   $0x6a
  jmp alltraps
80106de8:	e9 fd f5 ff ff       	jmp    801063ea <alltraps>
...
80106ded:	6a 00                	push   $0x0
  pushl $107
80106def:	6a 6b                	push   $0x6b
  jmp alltraps
80106df1:	e9 f4 f5 ff ff       	jmp    801063ea <alltraps>
...
80106df6:	6a 00                	push   $0x0
  pushl $108
80106df8:	6a 6c                	push   $0x6c
  jmp alltraps
80106dfa:	e9 eb f5 ff ff       	jmp    801063ea <alltraps>
...
80106dff:	6a 00                	push   $0x0
  pushl $109
80106e01:	6a 6d                	push   $0x6d
  jmp alltraps
80106e03:	e9 e2 f5 ff ff       	jmp    801063ea <alltraps>
...
80106e08:	6a 00                	push   $0x0
  pushl $110
80106e0a:	6a 6e                	push   $0x6e
  jmp alltraps
80106e0c:	e9 d9 f5 ff ff       	jmp    801063ea <alltraps>
...
80106e11:	6a 00                	push   $0x0
  pushl $111
80106e13:	6a 6f                	push   $0x6f
  jmp alltraps
80106e15:	e9 d0 f5 ff ff       	jmp    801063ea <alltraps>
...
80106e1a:	6a 00                	push   $0x0
  pushl $112
80106e1c:	6a 70                	push   $0x70
  jmp alltraps
80106e1e:	e9 c7 f5 ff ff       	jmp    801063ea <alltraps>
...
80106e23:	6a 00                	push   $0x0
  pushl $113
80106e25:	6a 71                	push   $0x71
  jmp alltraps
80106e27:	e9 be f5 ff ff       	jmp    801063ea <alltraps>
...
80106e2c:	6a 00                	push   $0x0
  pushl $114
80106e2e:	6a 72                	push   $0x72
  jmp alltraps
80106e30:	e9 b5 f5 ff ff       	jmp    801063ea <alltraps>
...
80106e35:	6a 00                	push   $0x0
  pushl $115
80106e37:	6a 73                	push   $0x73
  jmp alltraps
80106e39:	e9 ac f5 ff ff       	jmp    801063ea <alltraps>
...
80106e3e:	6a 00                	push   $0x0
  pushl $116
80106e40:	6a 74                	push   $0x74
  jmp alltraps
80106e42:	e9 a3 f5 ff ff       	jmp    801063ea <alltraps>
...
80106e47:	6a 00                	push   $0x0
  pushl $117
80106e49:	6a 75                	push   $0x75
  jmp alltraps
80106e4b:	e9 9a f5 ff ff       	jmp    801063ea <alltraps>
...
80106e50:	6a 00                	push   $0x0
  pushl $118
80106e52:	6a 76                	push   $0x76
  jmp alltraps
80106e54:	e9 91 f5 ff ff       	jmp    801063ea <alltraps>
...
80106e59:	6a 00                	push   $0x0
  pushl $119
80106e5b:	6a 77                	push   $0x77
  jmp alltraps
80106e5d:	e9 88 f5 ff ff       	jmp    801063ea <alltraps>
...
80106e62:	6a 00                	push   $0x0
  pushl $120
80106e64:	6a 78                	push   $0x78
  jmp alltraps
80106e66:	e9 7f f5 ff ff       	jmp    801063ea <alltraps>
...
80106e6b:	6a 00                	push   $0x0
  pushl $121
80106e6d:	6a 79                	push   $0x79
  jmp alltraps
80106e6f:	e9 76 f5 ff ff       	jmp    801063ea <alltraps>
...
80106e74:	6a 00                	push   $0x0
  pushl $122
80106e76:	6a 7a                	push   $0x7a
  jmp alltraps
80106e78:	e9 6d f5 ff ff       	jmp    801063ea <alltraps>
...
80106e7d:	6a 00                	push   $0x0
  pushl $123
80106e7f:	6a 7b                	push   $0x7b
  jmp alltraps
80106e81:	e9 64 f5 ff ff       	jmp    801063ea <alltraps>
...
80106e86:	6a 00                	push   $0x0
  pushl $124
80106e88:	6a 7c                	push   $0x7c
  jmp alltraps
80106e8a:	e9 5b f5 ff ff       	jmp    801063ea <alltraps>
...
80106e8f:	6a 00                	push   $0x0
  pushl $125
80106e91:	6a 7d                	push   $0x7d
  jmp alltraps
80106e93:	e9 52 f5 ff ff       	jmp    801063ea <alltraps>
...
80106e98:	6a 00                	push   $0x0
  pushl $126
80106e9a:	6a 7e                	push   $0x7e
  jmp alltraps
80106e9c:	e9 49 f5 ff ff       	jmp    801063ea <alltraps>
...
80106ea1:	6a 00                	push   $0x0
  pushl $127
80106ea3:	6a 7f                	push   $0x7f
  jmp alltraps
80106ea5:	e9 40 f5 ff ff       	jmp    801063ea <alltraps>
...
80106eaa:	6a 00                	push   $0x0
  pushl $128
80106eac:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106eb1:	e9 34 f5 ff ff       	jmp    801063ea <alltraps>
...
80106eb6:	6a 00                	push   $0x0
  pushl $129
80106eb8:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106ebd:	e9 28 f5 ff ff       	jmp    801063ea <alltraps>
...
80106ec2:	6a 00                	push   $0x0
  pushl $130
80106ec4:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106ec9:	e9 1c f5 ff ff       	jmp    801063ea <alltraps>
...
80106ece:	6a 00                	push   $0x0
  pushl $131
80106ed0:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106ed5:	e9 10 f5 ff ff       	jmp    801063ea <alltraps>
...
80106eda:	6a 00                	push   $0x0
  pushl $132
80106edc:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106ee1:	e9 04 f5 ff ff       	jmp    801063ea <alltraps>
...
80106ee6:	6a 00                	push   $0x0
  pushl $133
80106ee8:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106eed:	e9 f8 f4 ff ff       	jmp    801063ea <alltraps>
...
80106ef2:	6a 00                	push   $0x0
  pushl $134
80106ef4:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106ef9:	e9 ec f4 ff ff       	jmp    801063ea <alltraps>
...
80106efe:	6a 00                	push   $0x0
  pushl $135
80106f00:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106f05:	e9 e0 f4 ff ff       	jmp    801063ea <alltraps>
...
80106f0a:	6a 00                	push   $0x0
  pushl $136
80106f0c:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106f11:	e9 d4 f4 ff ff       	jmp    801063ea <alltraps>
...
80106f16:	6a 00                	push   $0x0
  pushl $137
80106f18:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106f1d:	e9 c8 f4 ff ff       	jmp    801063ea <alltraps>
...
80106f22:	6a 00                	push   $0x0
  pushl $138
80106f24:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106f29:	e9 bc f4 ff ff       	jmp    801063ea <alltraps>
...
80106f2e:	6a 00                	push   $0x0
  pushl $139
80106f30:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106f35:	e9 b0 f4 ff ff       	jmp    801063ea <alltraps>
...
80106f3a:	6a 00                	push   $0x0
  pushl $140
80106f3c:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106f41:	e9 a4 f4 ff ff       	jmp    801063ea <alltraps>
...
80106f46:	6a 00                	push   $0x0
  pushl $141
80106f48:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106f4d:	e9 98 f4 ff ff       	jmp    801063ea <alltraps>
...
80106f52:	6a 00                	push   $0x0
  pushl $142
80106f54:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106f59:	e9 8c f4 ff ff       	jmp    801063ea <alltraps>
...
80106f5e:	6a 00                	push   $0x0
  pushl $143
80106f60:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106f65:	e9 80 f4 ff ff       	jmp    801063ea <alltraps>
...
80106f6a:	6a 00                	push   $0x0
  pushl $144
80106f6c:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106f71:	e9 74 f4 ff ff       	jmp    801063ea <alltraps>
...
80106f76:	6a 00                	push   $0x0
  pushl $145
80106f78:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106f7d:	e9 68 f4 ff ff       	jmp    801063ea <alltraps>
...
80106f82:	6a 00                	push   $0x0
  pushl $146
80106f84:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106f89:	e9 5c f4 ff ff       	jmp    801063ea <alltraps>
...
80106f8e:	6a 00                	push   $0x0
  pushl $147
80106f90:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106f95:	e9 50 f4 ff ff       	jmp    801063ea <alltraps>
...
80106f9a:	6a 00                	push   $0x0
  pushl $148
80106f9c:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106fa1:	e9 44 f4 ff ff       	jmp    801063ea <alltraps>
...
80106fa6:	6a 00                	push   $0x0
  pushl $149
80106fa8:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106fad:	e9 38 f4 ff ff       	jmp    801063ea <alltraps>
...
80106fb2:	6a 00                	push   $0x0
  pushl $150
80106fb4:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106fb9:	e9 2c f4 ff ff       	jmp    801063ea <alltraps>
...
80106fbe:	6a 00                	push   $0x0
  pushl $151
80106fc0:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106fc5:	e9 20 f4 ff ff       	jmp    801063ea <alltraps>
...
80106fca:	6a 00                	push   $0x0
  pushl $152
80106fcc:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106fd1:	e9 14 f4 ff ff       	jmp    801063ea <alltraps>
...
80106fd6:	6a 00                	push   $0x0
  pushl $153
80106fd8:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106fdd:	e9 08 f4 ff ff       	jmp    801063ea <alltraps>
...
80106fe2:	6a 00                	push   $0x0
  pushl $154
80106fe4:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106fe9:	e9 fc f3 ff ff       	jmp    801063ea <alltraps>
...
80106fee:	6a 00                	push   $0x0
  pushl $155
80106ff0:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106ff5:	e9 f0 f3 ff ff       	jmp    801063ea <alltraps>
...
80106ffa:	6a 00                	push   $0x0
  pushl $156
80106ffc:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107001:	e9 e4 f3 ff ff       	jmp    801063ea <alltraps>
...
80107006:	6a 00                	push   $0x0
  pushl $157
80107008:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010700d:	e9 d8 f3 ff ff       	jmp    801063ea <alltraps>
...
80107012:	6a 00                	push   $0x0
  pushl $158
80107014:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107019:	e9 cc f3 ff ff       	jmp    801063ea <alltraps>
...
8010701e:	6a 00                	push   $0x0
  pushl $159
80107020:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107025:	e9 c0 f3 ff ff       	jmp    801063ea <alltraps>
...
8010702a:	6a 00                	push   $0x0
  pushl $160
8010702c:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107031:	e9 b4 f3 ff ff       	jmp    801063ea <alltraps>
...
80107036:	6a 00                	push   $0x0
  pushl $161
80107038:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010703d:	e9 a8 f3 ff ff       	jmp    801063ea <alltraps>
...
80107042:	6a 00                	push   $0x0
  pushl $162
80107044:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107049:	e9 9c f3 ff ff       	jmp    801063ea <alltraps>
...
8010704e:	6a 00                	push   $0x0
  pushl $163
80107050:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107055:	e9 90 f3 ff ff       	jmp    801063ea <alltraps>
...
8010705a:	6a 00                	push   $0x0
  pushl $164
8010705c:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107061:	e9 84 f3 ff ff       	jmp    801063ea <alltraps>
...
80107066:	6a 00                	push   $0x0
  pushl $165
80107068:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010706d:	e9 78 f3 ff ff       	jmp    801063ea <alltraps>
...
80107072:	6a 00                	push   $0x0
  pushl $166
80107074:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107079:	e9 6c f3 ff ff       	jmp    801063ea <alltraps>
...
8010707e:	6a 00                	push   $0x0
  pushl $167
80107080:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107085:	e9 60 f3 ff ff       	jmp    801063ea <alltraps>
...
8010708a:	6a 00                	push   $0x0
  pushl $168
8010708c:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107091:	e9 54 f3 ff ff       	jmp    801063ea <alltraps>
...
80107096:	6a 00                	push   $0x0
  pushl $169
80107098:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010709d:	e9 48 f3 ff ff       	jmp    801063ea <alltraps>
...
801070a2:	6a 00                	push   $0x0
  pushl $170
801070a4:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801070a9:	e9 3c f3 ff ff       	jmp    801063ea <alltraps>
...
801070ae:	6a 00                	push   $0x0
  pushl $171
801070b0:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801070b5:	e9 30 f3 ff ff       	jmp    801063ea <alltraps>
...
801070ba:	6a 00                	push   $0x0
  pushl $172
801070bc:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801070c1:	e9 24 f3 ff ff       	jmp    801063ea <alltraps>
...
801070c6:	6a 00                	push   $0x0
  pushl $173
801070c8:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801070cd:	e9 18 f3 ff ff       	jmp    801063ea <alltraps>
...
801070d2:	6a 00                	push   $0x0
  pushl $174
801070d4:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801070d9:	e9 0c f3 ff ff       	jmp    801063ea <alltraps>
...
801070de:	6a 00                	push   $0x0
  pushl $175
801070e0:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801070e5:	e9 00 f3 ff ff       	jmp    801063ea <alltraps>
...
801070ea:	6a 00                	push   $0x0
  pushl $176
801070ec:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801070f1:	e9 f4 f2 ff ff       	jmp    801063ea <alltraps>
...
801070f6:	6a 00                	push   $0x0
  pushl $177
801070f8:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801070fd:	e9 e8 f2 ff ff       	jmp    801063ea <alltraps>
...
80107102:	6a 00                	push   $0x0
  pushl $178
80107104:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107109:	e9 dc f2 ff ff       	jmp    801063ea <alltraps>
...
8010710e:	6a 00                	push   $0x0
  pushl $179
80107110:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107115:	e9 d0 f2 ff ff       	jmp    801063ea <alltraps>
...
8010711a:	6a 00                	push   $0x0
  pushl $180
8010711c:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107121:	e9 c4 f2 ff ff       	jmp    801063ea <alltraps>
...
80107126:	6a 00                	push   $0x0
  pushl $181
80107128:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010712d:	e9 b8 f2 ff ff       	jmp    801063ea <alltraps>
...
80107132:	6a 00                	push   $0x0
  pushl $182
80107134:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107139:	e9 ac f2 ff ff       	jmp    801063ea <alltraps>
...
8010713e:	6a 00                	push   $0x0
  pushl $183
80107140:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107145:	e9 a0 f2 ff ff       	jmp    801063ea <alltraps>
...
8010714a:	6a 00                	push   $0x0
  pushl $184
8010714c:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107151:	e9 94 f2 ff ff       	jmp    801063ea <alltraps>
...
80107156:	6a 00                	push   $0x0
  pushl $185
80107158:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010715d:	e9 88 f2 ff ff       	jmp    801063ea <alltraps>
...
80107162:	6a 00                	push   $0x0
  pushl $186
80107164:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107169:	e9 7c f2 ff ff       	jmp    801063ea <alltraps>
...
8010716e:	6a 00                	push   $0x0
  pushl $187
80107170:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107175:	e9 70 f2 ff ff       	jmp    801063ea <alltraps>
...
8010717a:	6a 00                	push   $0x0
  pushl $188
8010717c:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107181:	e9 64 f2 ff ff       	jmp    801063ea <alltraps>
...
80107186:	6a 00                	push   $0x0
  pushl $189
80107188:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010718d:	e9 58 f2 ff ff       	jmp    801063ea <alltraps>
...
80107192:	6a 00                	push   $0x0
  pushl $190
80107194:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107199:	e9 4c f2 ff ff       	jmp    801063ea <alltraps>
...
8010719e:	6a 00                	push   $0x0
  pushl $191
801071a0:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801071a5:	e9 40 f2 ff ff       	jmp    801063ea <alltraps>
...
801071aa:	6a 00                	push   $0x0
  pushl $192
801071ac:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801071b1:	e9 34 f2 ff ff       	jmp    801063ea <alltraps>
...
801071b6:	6a 00                	push   $0x0
  pushl $193
801071b8:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801071bd:	e9 28 f2 ff ff       	jmp    801063ea <alltraps>
...
801071c2:	6a 00                	push   $0x0
  pushl $194
801071c4:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801071c9:	e9 1c f2 ff ff       	jmp    801063ea <alltraps>
...
801071ce:	6a 00                	push   $0x0
  pushl $195
801071d0:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801071d5:	e9 10 f2 ff ff       	jmp    801063ea <alltraps>
...
801071da:	6a 00                	push   $0x0
  pushl $196
801071dc:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801071e1:	e9 04 f2 ff ff       	jmp    801063ea <alltraps>
...
801071e6:	6a 00                	push   $0x0
  pushl $197
801071e8:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801071ed:	e9 f8 f1 ff ff       	jmp    801063ea <alltraps>
...
801071f2:	6a 00                	push   $0x0
  pushl $198
801071f4:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801071f9:	e9 ec f1 ff ff       	jmp    801063ea <alltraps>
...
801071fe:	6a 00                	push   $0x0
  pushl $199
80107200:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107205:	e9 e0 f1 ff ff       	jmp    801063ea <alltraps>
...
8010720a:	6a 00                	push   $0x0
  pushl $200
8010720c:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107211:	e9 d4 f1 ff ff       	jmp    801063ea <alltraps>
...
80107216:	6a 00                	push   $0x0
  pushl $201
80107218:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010721d:	e9 c8 f1 ff ff       	jmp    801063ea <alltraps>
...
80107222:	6a 00                	push   $0x0
  pushl $202
80107224:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107229:	e9 bc f1 ff ff       	jmp    801063ea <alltraps>
...
8010722e:	6a 00                	push   $0x0
  pushl $203
80107230:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107235:	e9 b0 f1 ff ff       	jmp    801063ea <alltraps>
...
8010723a:	6a 00                	push   $0x0
  pushl $204
8010723c:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107241:	e9 a4 f1 ff ff       	jmp    801063ea <alltraps>
...
80107246:	6a 00                	push   $0x0
  pushl $205
80107248:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010724d:	e9 98 f1 ff ff       	jmp    801063ea <alltraps>
...
80107252:	6a 00                	push   $0x0
  pushl $206
80107254:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107259:	e9 8c f1 ff ff       	jmp    801063ea <alltraps>
...
8010725e:	6a 00                	push   $0x0
  pushl $207
80107260:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107265:	e9 80 f1 ff ff       	jmp    801063ea <alltraps>
...
8010726a:	6a 00                	push   $0x0
  pushl $208
8010726c:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107271:	e9 74 f1 ff ff       	jmp    801063ea <alltraps>
...
80107276:	6a 00                	push   $0x0
  pushl $209
80107278:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010727d:	e9 68 f1 ff ff       	jmp    801063ea <alltraps>
...
80107282:	6a 00                	push   $0x0
  pushl $210
80107284:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107289:	e9 5c f1 ff ff       	jmp    801063ea <alltraps>
...
8010728e:	6a 00                	push   $0x0
  pushl $211
80107290:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107295:	e9 50 f1 ff ff       	jmp    801063ea <alltraps>
...
8010729a:	6a 00                	push   $0x0
  pushl $212
8010729c:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801072a1:	e9 44 f1 ff ff       	jmp    801063ea <alltraps>
...
801072a6:	6a 00                	push   $0x0
  pushl $213
801072a8:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801072ad:	e9 38 f1 ff ff       	jmp    801063ea <alltraps>
...
801072b2:	6a 00                	push   $0x0
  pushl $214
801072b4:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801072b9:	e9 2c f1 ff ff       	jmp    801063ea <alltraps>
...
801072be:	6a 00                	push   $0x0
  pushl $215
801072c0:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801072c5:	e9 20 f1 ff ff       	jmp    801063ea <alltraps>
...
801072ca:	6a 00                	push   $0x0
  pushl $216
801072cc:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801072d1:	e9 14 f1 ff ff       	jmp    801063ea <alltraps>
...
801072d6:	6a 00                	push   $0x0
  pushl $217
801072d8:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801072dd:	e9 08 f1 ff ff       	jmp    801063ea <alltraps>
...
801072e2:	6a 00                	push   $0x0
  pushl $218
801072e4:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801072e9:	e9 fc f0 ff ff       	jmp    801063ea <alltraps>
...
801072ee:	6a 00                	push   $0x0
  pushl $219
801072f0:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801072f5:	e9 f0 f0 ff ff       	jmp    801063ea <alltraps>
...
801072fa:	6a 00                	push   $0x0
  pushl $220
801072fc:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107301:	e9 e4 f0 ff ff       	jmp    801063ea <alltraps>
...
80107306:	6a 00                	push   $0x0
  pushl $221
80107308:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010730d:	e9 d8 f0 ff ff       	jmp    801063ea <alltraps>
...
80107312:	6a 00                	push   $0x0
  pushl $222
80107314:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107319:	e9 cc f0 ff ff       	jmp    801063ea <alltraps>
...
8010731e:	6a 00                	push   $0x0
  pushl $223
80107320:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107325:	e9 c0 f0 ff ff       	jmp    801063ea <alltraps>
...
8010732a:	6a 00                	push   $0x0
  pushl $224
8010732c:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107331:	e9 b4 f0 ff ff       	jmp    801063ea <alltraps>
...
80107336:	6a 00                	push   $0x0
  pushl $225
80107338:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010733d:	e9 a8 f0 ff ff       	jmp    801063ea <alltraps>
...
80107342:	6a 00                	push   $0x0
  pushl $226
80107344:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107349:	e9 9c f0 ff ff       	jmp    801063ea <alltraps>
...
8010734e:	6a 00                	push   $0x0
  pushl $227
80107350:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107355:	e9 90 f0 ff ff       	jmp    801063ea <alltraps>
...
8010735a:	6a 00                	push   $0x0
  pushl $228
8010735c:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107361:	e9 84 f0 ff ff       	jmp    801063ea <alltraps>
...
80107366:	6a 00                	push   $0x0
  pushl $229
80107368:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010736d:	e9 78 f0 ff ff       	jmp    801063ea <alltraps>
...
80107372:	6a 00                	push   $0x0
  pushl $230
80107374:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107379:	e9 6c f0 ff ff       	jmp    801063ea <alltraps>
...
8010737e:	6a 00                	push   $0x0
  pushl $231
80107380:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107385:	e9 60 f0 ff ff       	jmp    801063ea <alltraps>
...
8010738a:	6a 00                	push   $0x0
  pushl $232
8010738c:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107391:	e9 54 f0 ff ff       	jmp    801063ea <alltraps>
...
80107396:	6a 00                	push   $0x0
  pushl $233
80107398:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010739d:	e9 48 f0 ff ff       	jmp    801063ea <alltraps>
...
801073a2:	6a 00                	push   $0x0
  pushl $234
801073a4:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801073a9:	e9 3c f0 ff ff       	jmp    801063ea <alltraps>
...
801073ae:	6a 00                	push   $0x0
  pushl $235
801073b0:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801073b5:	e9 30 f0 ff ff       	jmp    801063ea <alltraps>
...
801073ba:	6a 00                	push   $0x0
  pushl $236
801073bc:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801073c1:	e9 24 f0 ff ff       	jmp    801063ea <alltraps>
...
801073c6:	6a 00                	push   $0x0
  pushl $237
801073c8:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801073cd:	e9 18 f0 ff ff       	jmp    801063ea <alltraps>
...
801073d2:	6a 00                	push   $0x0
  pushl $238
801073d4:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801073d9:	e9 0c f0 ff ff       	jmp    801063ea <alltraps>
...
801073de:	6a 00                	push   $0x0
  pushl $239
801073e0:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801073e5:	e9 00 f0 ff ff       	jmp    801063ea <alltraps>
...
801073ea:	6a 00                	push   $0x0
  pushl $240
801073ec:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801073f1:	e9 f4 ef ff ff       	jmp    801063ea <alltraps>
...
801073f6:	6a 00                	push   $0x0
  pushl $241
801073f8:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801073fd:	e9 e8 ef ff ff       	jmp    801063ea <alltraps>
...
80107402:	6a 00                	push   $0x0
  pushl $242
80107404:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107409:	e9 dc ef ff ff       	jmp    801063ea <alltraps>
...
8010740e:	6a 00                	push   $0x0
  pushl $243
80107410:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107415:	e9 d0 ef ff ff       	jmp    801063ea <alltraps>
...
8010741a:	6a 00                	push   $0x0
  pushl $244
8010741c:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107421:	e9 c4 ef ff ff       	jmp    801063ea <alltraps>
...
80107426:	6a 00                	push   $0x0
  pushl $245
80107428:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010742d:	e9 b8 ef ff ff       	jmp    801063ea <alltraps>
...
80107432:	6a 00                	push   $0x0
  pushl $246
80107434:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107439:	e9 ac ef ff ff       	jmp    801063ea <alltraps>
...
8010743e:	6a 00                	push   $0x0
  pushl $247
80107440:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107445:	e9 a0 ef ff ff       	jmp    801063ea <alltraps>
...
8010744a:	6a 00                	push   $0x0
  pushl $248
8010744c:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107451:	e9 94 ef ff ff       	jmp    801063ea <alltraps>
...
80107456:	6a 00                	push   $0x0
  pushl $249
80107458:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010745d:	e9 88 ef ff ff       	jmp    801063ea <alltraps>
...
80107462:	6a 00                	push   $0x0
  pushl $250
80107464:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107469:	e9 7c ef ff ff       	jmp    801063ea <alltraps>
...
8010746e:	6a 00                	push   $0x0
  pushl $251
80107470:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107475:	e9 70 ef ff ff       	jmp    801063ea <alltraps>
...
8010747a:	6a 00                	push   $0x0
  pushl $252
8010747c:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107481:	e9 64 ef ff ff       	jmp    801063ea <alltraps>
...
80107486:	6a 00                	push   $0x0
  pushl $253
80107488:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010748d:	e9 58 ef ff ff       	jmp    801063ea <alltraps>
...
80107492:	6a 00                	push   $0x0
  pushl $254
80107494:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107499:	e9 4c ef ff ff       	jmp    801063ea <alltraps>
...
8010749e:	6a 00                	push   $0x0
  pushl $255
801074a0:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801074a5:	e9 40 ef ff ff       	jmp    801063ea <alltraps>

801074aa <lgdt>:
{
801074aa:	55                   	push   %ebp
801074ab:	89 e5                	mov    %esp,%ebp
801074ad:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
801074b0:	8b 45 0c             	mov    0xc(%ebp),%eax
801074b3:	83 e8 01             	sub    $0x1,%eax
801074b6:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801074ba:	8b 45 08             	mov    0x8(%ebp),%eax
801074bd:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801074c1:	8b 45 08             	mov    0x8(%ebp),%eax
801074c4:	c1 e8 10             	shr    $0x10,%eax
801074c7:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
801074cb:	8d 45 fa             	lea    -0x6(%ebp),%eax
801074ce:	0f 01 10             	lgdtl  (%eax)
}
801074d1:	c9                   	leave  
801074d2:	c3                   	ret    
...
801074f7:	83 ec 28             	sub    $0x28,%esp
  ...
  c = &cpus[cpuid()];
801074fa:	e8 cb cb ff ff       	call   801040ca <cpuid>
801074ff:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80107505:	05 00 38 11 80       	add    $0x80113800,%eax
8010750a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010750d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107510:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107516:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107519:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
8010751f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107522:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107526:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107529:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
8010752d:	83 e2 f0             	and    $0xfffffff0,%edx
80107530:	83 ca 0a             	or     $0xa,%edx
80107533:	88 50 7d             	mov    %dl,0x7d(%eax)
80107536:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107539:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
8010753d:	83 ca 10             	or     $0x10,%edx
80107540:	88 50 7d             	mov    %dl,0x7d(%eax)
80107543:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107546:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
8010754a:	83 e2 9f             	and    $0xffffff9f,%edx
...
80107571:	83 e2 ef             	and    $0xffffffef,%edx
...
801075a1:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801075a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075a8:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
801075af:	ff ff 
801075b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075b4:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
801075bb:	00 00 
801075bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075c0:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
...
801075d7:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
801075dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075e0:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801075e7:	83 ca 10             	or     $0x10,%edx
801075ea:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
801075f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075f3:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801075fa:	83 e2 9f             	and    $0xffffff9f,%edx
...
80107619:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107620:	83 ca 0f             	or     $0xf,%edx
80107623:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107629:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010762c:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
...
80107678:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010767f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107682:	66 c7 80 88 00 00 00 	movw   $0xffff,0x88(%eax)
80107689:	ff ff 
8010768b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010768e:	66 c7 80 8a 00 00 00 	movw   $0x0,0x8a(%eax)
80107695:	00 00 
80107697:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010769a:	c6 80 8c 00 00 00 00 	movb   $0x0,0x8c(%eax)
801076a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076a4:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801076ab:	83 e2 f0             	and    $0xfffffff0,%edx
801076ae:	83 ca 0a             	or     $0xa,%edx
801076b1:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801076b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076ba:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801076c1:	83 ca 10             	or     $0x10,%edx
801076c4:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801076ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076cd:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801076d4:	83 ca 60             	or     $0x60,%edx
...
801076f3:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
801076fa:	83 ca 0f             	or     $0xf,%edx
801076fd:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107703:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107706:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
8010770d:	83 e2 ef             	and    $0xffffffef,%edx
80107710:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107716:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107719:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80107720:	83 e2 df             	and    $0xffffffdf,%edx
...
80107752:	c6 80 8f 00 00 00 00 	movb   $0x0,0x8f(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107759:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010775c:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80107763:	ff ff 
80107765:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107768:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
8010776f:	00 00 
80107771:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107774:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
8010777b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010777e:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107785:	83 e2 f0             	and    $0xfffffff0,%edx
80107788:	83 ca 02             	or     $0x2,%edx
8010778b:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107791:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107794:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
8010779b:	83 ca 10             	or     $0x10,%edx
8010779e:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
801077a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077a7:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
801077ae:	83 ca 60             	or     $0x60,%edx
...
801077cd:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
801077d4:	83 ca 0f             	or     $0xf,%edx
801077d7:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801077dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077e0:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
...
801077fa:	83 e2 df             	and    $0xffffffdf,%edx
...
8010782c:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
80107833:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107836:	83 c0 70             	add    $0x70,%eax
80107839:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
80107840:	00 
80107841:	89 04 24             	mov    %eax,(%esp)
80107844:	e8 61 fc ff ff       	call   801074aa <lgdt>
}
80107849:	c9                   	leave  
8010784a:	c3                   	ret    
...
8010784e:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;
...
80107857:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80107870:	74 14                	je     80107886 <walkpgdir+0x3b>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107872:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107875:	8b 00                	mov    (%eax),%eax
80107877:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010787c:	05 00 00 00 80       	add    $0x80000000,%eax
80107881:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107884:	eb 48                	jmp    801078ce <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107886:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010788a:	74 0e                	je     8010789a <walkpgdir+0x4f>
8010788c:	e8 18 b3 ff ff       	call   80102ba9 <kalloc>
80107891:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107894:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107898:	75 07                	jne    801078a1 <walkpgdir+0x56>
      return 0;
8010789a:	b8 00 00 00 00       	mov    $0x0,%eax
8010789f:	eb 44                	jmp    801078e5 <walkpgdir+0x9a>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
801078a1:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801078a8:	00 
801078a9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801078b0:	00 
801078b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078b4:	89 04 24             	mov    %eax,(%esp)
801078b7:	e8 4e d7 ff ff       	call   8010500a <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
801078bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078bf:	05 00 00 00 80       	add    $0x80000000,%eax
801078c4:	83 c8 07             	or     $0x7,%eax
801078c7:	89 c2                	mov    %eax,%edx
801078c9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801078cc:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
801078ce:	8b 45 0c             	mov    0xc(%ebp),%eax
801078d1:	c1 e8 0c             	shr    $0xc,%eax
801078d4:	25 ff 03 00 00       	and    $0x3ff,%eax
801078d9:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801078e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078e3:	01 d0                	add    %edx,%eax
}
801078e5:	c9                   	leave  
801078e6:	c3                   	ret    
...
801078f0:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801078f5:	89 45 f4             	mov    %eax,-0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801078f8:	8b 55 0c             	mov    0xc(%ebp),%edx
801078fb:	8b 45 10             	mov    0x10(%ebp),%eax
801078fe:	01 d0                	add    %edx,%eax
...
80107963:	75 08                	jne    8010796d <mappages+0x86>
      break;
80107965:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
  ...
  return 0;
80107966:	b8 00 00 00 00       	mov    $0x0,%eax
8010796b:	eb 10                	jmp    8010797d <mappages+0x96>
    a += PGSIZE;
8010796d:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80107974:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
8010797b:	eb 8e                	jmp    8010790b <mappages+0x24>
}
8010797d:	c9                   	leave  
8010797e:	c3                   	ret    
...
80107983:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107986:	e8 1e b2 ff ff       	call   80102ba9 <kalloc>
8010798b:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010798e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107992:	75 0a                	jne    8010799e <setupkvm+0x1f>
    return 0;
80107994:	b8 00 00 00 00       	mov    $0x0,%eax
80107999:	e9 84 00 00 00       	jmp    80107a22 <setupkvm+0xa3>
  memset(pgdir, 0, PGSIZE);
8010799e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801079a5:	00 
801079a6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801079ad:	00 
801079ae:	8b 45 f0             	mov    -0x10(%ebp),%eax
801079b1:	89 04 24             	mov    %eax,(%esp)
801079b4:	e8 51 d6 ff ff       	call   8010500a <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801079b9:	c7 45 f4 80 b4 10 80 	movl   $0x8010b480,-0xc(%ebp)
801079c0:	eb 54                	jmp    80107a16 <setupkvm+0x97>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
801079c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079c5:	8b 48 0c             	mov    0xc(%eax),%ecx
801079c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079cb:	8b 50 04             	mov    0x4(%eax),%edx
801079ce:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079d1:	8b 58 08             	mov    0x8(%eax),%ebx
801079d4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079d7:	8b 40 04             	mov    0x4(%eax),%eax
801079da:	29 c3                	sub    %eax,%ebx
801079dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079df:	8b 00                	mov    (%eax),%eax
801079e1:	89 4c 24 10          	mov    %ecx,0x10(%esp)
801079e5:	89 54 24 0c          	mov    %edx,0xc(%esp)
801079e9:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801079ed:	89 44 24 04          	mov    %eax,0x4(%esp)
801079f1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801079f4:	89 04 24             	mov    %eax,(%esp)
801079f7:	e8 eb fe ff ff       	call   801078e7 <mappages>
801079fc:	85 c0                	test   %eax,%eax
801079fe:	79 12                	jns    80107a12 <setupkvm+0x93>
                (uint)k->phys_start, k->perm) < 0) {
      freevm(pgdir);
80107a00:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107a03:	89 04 24             	mov    %eax,(%esp)
80107a06:	e8 26 05 00 00       	call   80107f31 <freevm>
      return 0;
80107a0b:	b8 00 00 00 00       	mov    $0x0,%eax
80107a10:	eb 10                	jmp    80107a22 <setupkvm+0xa3>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107a12:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107a16:	81 7d f4 c0 b4 10 80 	cmpl   $0x8010b4c0,-0xc(%ebp)
80107a1d:	72 a3                	jb     801079c2 <setupkvm+0x43>
    }
  return pgdir;
80107a1f:	8b 45 f0             	mov    -0x10(%ebp),%eax
}
80107a22:	83 c4 34             	add    $0x34,%esp
80107a25:	5b                   	pop    %ebx
80107a26:	5d                   	pop    %ebp
80107a27:	c3                   	ret    
...
80107a2b:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107a2e:	e8 4c ff ff ff       	call   8010797f <setupkvm>
80107a33:	a3 24 65 11 80       	mov    %eax,0x80116524
  switchkvm();
80107a38:	e8 02 00 00 00       	call   80107a3f <switchkvm>
}
80107a3d:	c9                   	leave  
80107a3e:	c3                   	ret    
...
80107a42:	83 ec 04             	sub    $0x4,%esp
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80107a45:	a1 24 65 11 80       	mov    0x80116524,%eax
80107a4a:	05 00 00 00 80       	add    $0x80000000,%eax
80107a4f:	89 04 24             	mov    %eax,(%esp)
80107a52:	e8 92 fa ff ff       	call   801074e9 <lcr3>
}
80107a57:	c9                   	leave  
80107a58:	c3                   	ret    
...
80107a5c:	57                   	push   %edi
80107a5d:	56                   	push   %esi
80107a5e:	53                   	push   %ebx
80107a5f:	83 ec 1c             	sub    $0x1c,%esp
  if(p == 0)
80107a62:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80107a66:	75 0c                	jne    80107a74 <switchuvm+0x1b>
    panic("switchuvm: no process");
80107a68:	c7 04 24 72 88 10 80 	movl   $0x80108872,(%esp)
80107a6f:	e8 ee 8a ff ff       	call   80100562 <panic>
  if(p->kstack == 0)
80107a74:	8b 45 08             	mov    0x8(%ebp),%eax
80107a77:	8b 40 08             	mov    0x8(%eax),%eax
80107a7a:	85 c0                	test   %eax,%eax
80107a7c:	75 0c                	jne    80107a8a <switchuvm+0x31>
    panic("switchuvm: no kstack");
80107a7e:	c7 04 24 88 88 10 80 	movl   $0x80108888,(%esp)
80107a85:	e8 d8 8a ff ff       	call   80100562 <panic>
  if(p->pgdir == 0)
80107a8a:	8b 45 08             	mov    0x8(%ebp),%eax
80107a8d:	8b 40 04             	mov    0x4(%eax),%eax
80107a90:	85 c0                	test   %eax,%eax
80107a92:	75 0c                	jne    80107aa0 <switchuvm+0x47>
    panic("switchuvm: no pgdir");
80107a94:	c7 04 24 9d 88 10 80 	movl   $0x8010889d,(%esp)
80107a9b:	e8 c2 8a ff ff       	call   80100562 <panic>

  pushcli();
80107aa0:	e8 60 d4 ff ff       	call   80104f05 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80107aa5:	e8 41 c6 ff ff       	call   801040eb <mycpu>
80107aaa:	89 c3                	mov    %eax,%ebx
80107aac:	e8 3a c6 ff ff       	call   801040eb <mycpu>
80107ab1:	83 c0 08             	add    $0x8,%eax
80107ab4:	89 c7                	mov    %eax,%edi
80107ab6:	e8 30 c6 ff ff       	call   801040eb <mycpu>
80107abb:	83 c0 08             	add    $0x8,%eax
80107abe:	c1 e8 10             	shr    $0x10,%eax
80107ac1:	89 c6                	mov    %eax,%esi
80107ac3:	e8 23 c6 ff ff       	call   801040eb <mycpu>
80107ac8:	83 c0 08             	add    $0x8,%eax
80107acb:	c1 e8 18             	shr    $0x18,%eax
80107ace:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
80107ad5:	67 00 
80107ad7:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80107ade:	89 f1                	mov    %esi,%ecx
80107ae0:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80107ae6:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107aed:	83 e2 f0             	and    $0xfffffff0,%edx
80107af0:	83 ca 09             	or     $0x9,%edx
80107af3:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107af9:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107b00:	83 ca 10             	or     $0x10,%edx
80107b03:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107b09:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107b10:	83 e2 9f             	and    $0xffffff9f,%edx
80107b13:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107b19:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107b20:	83 ca 80             	or     $0xffffff80,%edx
80107b23:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107b29:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107b30:	83 e2 f0             	and    $0xfffffff0,%edx
80107b33:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107b39:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107b40:	83 e2 ef             	and    $0xffffffef,%edx
80107b43:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107b49:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107b50:	83 e2 df             	and    $0xffffffdf,%edx
80107b53:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107b59:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107b60:	83 ca 40             	or     $0x40,%edx
80107b63:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107b69:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107b70:	83 e2 7f             	and    $0x7f,%edx
80107b73:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107b79:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80107b7f:	e8 67 c5 ff ff       	call   801040eb <mycpu>
80107b84:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107b8b:	83 e2 ef             	and    $0xffffffef,%edx
80107b8e:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80107b94:	e8 52 c5 ff ff       	call   801040eb <mycpu>
80107b99:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80107b9f:	e8 47 c5 ff ff       	call   801040eb <mycpu>
80107ba4:	8b 55 08             	mov    0x8(%ebp),%edx
80107ba7:	8b 52 08             	mov    0x8(%edx),%edx
80107baa:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107bb0:	89 50 0c             	mov    %edx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80107bb3:	e8 33 c5 ff ff       	call   801040eb <mycpu>
80107bb8:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  ltr(SEG_TSS << 3);
80107bbe:	c7 04 24 28 00 00 00 	movl   $0x28,(%esp)
80107bc5:	e8 09 f9 ff ff       	call   801074d3 <ltr>
...
80107bd8:	e8 0c f9 ff ff       	call   801074e9 <lcr3>
  popcli();
80107bdd:	e8 6f d3 ff ff       	call   80104f51 <popcli>
}
80107be2:	83 c4 1c             	add    $0x1c,%esp
80107be5:	5b                   	pop    %ebx
80107be6:	5e                   	pop    %esi
80107be7:	5f                   	pop    %edi
80107be8:	5d                   	pop    %ebp
...
80107bed:	83 ec 38             	sub    $0x38,%esp
  char *mem;

  if(sz >= PGSIZE)
80107bf0:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107bf7:	76 0c                	jbe    80107c05 <inituvm+0x1b>
    panic("inituvm: more than a page");
80107bf9:	c7 04 24 b1 88 10 80 	movl   $0x801088b1,(%esp)
80107c00:	e8 5d 89 ff ff       	call   80100562 <panic>
  mem = kalloc();
80107c05:	e8 9f af ff ff       	call   80102ba9 <kalloc>
80107c0a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
80107c0d:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107c14:	00 
80107c15:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107c1c:	00 
80107c1d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c20:	89 04 24             	mov    %eax,(%esp)
80107c23:	e8 e2 d3 ff ff       	call   8010500a <memset>
...
80107c52:	e8 90 fc ff ff       	call   801078e7 <mappages>
  memmove(mem, init, sz);
...
80107c6b:	e8 69 d4 ff ff       	call   801050d9 <memmove>
}
80107c70:	c9                   	leave  
80107c71:	c3                   	ret    
...
80107c7b:	25 ff 0f 00 00       	and    $0xfff,%eax
80107c80:	85 c0                	test   %eax,%eax
80107c82:	74 0c                	je     80107c90 <loaduvm+0x1e>
    panic("loaduvm: addr must be page aligned");
80107c84:	c7 04 24 cc 88 10 80 	movl   $0x801088cc,(%esp)
80107c8b:	e8 d2 88 ff ff       	call   80100562 <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107c90:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107c97:	e9 a6 00 00 00       	jmp    80107d42 <loaduvm+0xd0>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107c9c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c9f:	8b 55 0c             	mov    0xc(%ebp),%edx
80107ca2:	01 d0                	add    %edx,%eax
80107ca4:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107cab:	00 
80107cac:	89 44 24 04          	mov    %eax,0x4(%esp)
80107cb0:	8b 45 08             	mov    0x8(%ebp),%eax
80107cb3:	89 04 24             	mov    %eax,(%esp)
80107cb6:	e8 90 fb ff ff       	call   8010784b <walkpgdir>
80107cbb:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107cbe:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107cc2:	75 0c                	jne    80107cd0 <loaduvm+0x5e>
      panic("loaduvm: address should exist");
80107cc4:	c7 04 24 ef 88 10 80 	movl   $0x801088ef,(%esp)
80107ccb:	e8 92 88 ff ff       	call   80100562 <panic>
    pa = PTE_ADDR(*pte);
80107cd0:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107cd3:	8b 00                	mov    (%eax),%eax
80107cd5:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107cda:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80107cdd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ce0:	8b 55 18             	mov    0x18(%ebp),%edx
80107ce3:	29 c2                	sub    %eax,%edx
80107ce5:	89 d0                	mov    %edx,%eax
80107ce7:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80107cec:	77 0f                	ja     80107cfd <loaduvm+0x8b>
      n = sz - i;
80107cee:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cf1:	8b 55 18             	mov    0x18(%ebp),%edx
80107cf4:	29 c2                	sub    %eax,%edx
80107cf6:	89 d0                	mov    %edx,%eax
80107cf8:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107cfb:	eb 07                	jmp    80107d04 <loaduvm+0x92>
    else
      n = PGSIZE;
80107cfd:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80107d04:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d07:	8b 55 14             	mov    0x14(%ebp),%edx
80107d0a:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
80107d0d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107d10:	05 00 00 00 80       	add    $0x80000000,%eax
80107d15:	8b 55 f0             	mov    -0x10(%ebp),%edx
80107d18:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107d1c:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80107d20:	89 44 24 04          	mov    %eax,0x4(%esp)
80107d24:	8b 45 10             	mov    0x10(%ebp),%eax
80107d27:	89 04 24             	mov    %eax,(%esp)
80107d2a:	e8 cb a0 ff ff       	call   80101dfa <readi>
80107d2f:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107d32:	74 07                	je     80107d3b <loaduvm+0xc9>
      return -1;
80107d34:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107d39:	eb 18                	jmp    80107d53 <loaduvm+0xe1>
  for(i = 0; i < sz; i += PGSIZE){
80107d3b:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107d42:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d45:	3b 45 18             	cmp    0x18(%ebp),%eax
80107d48:	0f 82 4e ff ff ff    	jb     80107c9c <loaduvm+0x2a>
  }
  return 0;
...
80107d58:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
80107d60:	79 0a                	jns    80107d6c <allocuvm+0x17>
    return 0;
80107d62:	b8 00 00 00 00       	mov    $0x0,%eax
80107d67:	e9 fd 00 00 00       	jmp    80107e69 <allocuvm+0x114>
  if(newsz < oldsz)
80107d6c:	8b 45 10             	mov    0x10(%ebp),%eax
80107d6f:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107d72:	73 08                	jae    80107d7c <allocuvm+0x27>
    return oldsz;
80107d74:	8b 45 0c             	mov    0xc(%ebp),%eax
80107d77:	e9 ed 00 00 00       	jmp    80107e69 <allocuvm+0x114>

  a = PGROUNDUP(oldsz);
80107d7c:	8b 45 0c             	mov    0xc(%ebp),%eax
80107d7f:	05 ff 0f 00 00       	add    $0xfff,%eax
80107d84:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107d89:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80107d8c:	e9 c9 00 00 00       	jmp    80107e5a <allocuvm+0x105>
    mem = kalloc();
80107d91:	e8 13 ae ff ff       	call   80102ba9 <kalloc>
80107d96:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80107d99:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107d9d:	75 2f                	jne    80107dce <allocuvm+0x79>
      cprintf("allocuvm out of memory\n");
80107d9f:	c7 04 24 0d 89 10 80 	movl   $0x8010890d,(%esp)
80107da6:	e8 1d 86 ff ff       	call   801003c8 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80107dab:	8b 45 0c             	mov    0xc(%ebp),%eax
80107dae:	89 44 24 08          	mov    %eax,0x8(%esp)
80107db2:	8b 45 10             	mov    0x10(%ebp),%eax
80107db5:	89 44 24 04          	mov    %eax,0x4(%esp)
80107db9:	8b 45 08             	mov    0x8(%ebp),%eax
80107dbc:	89 04 24             	mov    %eax,(%esp)
80107dbf:	e8 a7 00 00 00       	call   80107e6b <deallocuvm>
      return 0;
80107dc4:	b8 00 00 00 00       	mov    $0x0,%eax
80107dc9:	e9 9b 00 00 00       	jmp    80107e69 <allocuvm+0x114>
    }
    memset(mem, 0, PGSIZE);
...
80107de4:	e8 21 d2 ff ff       	call   8010500a <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80107de9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107dec:	8d 90 00 00 00 80    	lea    -0x80000000(%eax),%edx
80107df2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107df5:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107dfc:	00 
80107dfd:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107e01:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107e08:	00 
80107e09:	89 44 24 04          	mov    %eax,0x4(%esp)
80107e0d:	8b 45 08             	mov    0x8(%ebp),%eax
80107e10:	89 04 24             	mov    %eax,(%esp)
80107e13:	e8 cf fa ff ff       	call   801078e7 <mappages>
80107e18:	85 c0                	test   %eax,%eax
80107e1a:	79 37                	jns    80107e53 <allocuvm+0xfe>
      cprintf("allocuvm out of memory (2)\n");
80107e1c:	c7 04 24 25 89 10 80 	movl   $0x80108925,(%esp)
80107e23:	e8 a0 85 ff ff       	call   801003c8 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80107e28:	8b 45 0c             	mov    0xc(%ebp),%eax
80107e2b:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80107e3c:	e8 2a 00 00 00       	call   80107e6b <deallocuvm>
      kfree(mem);
80107e41:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107e44:	89 04 24             	mov    %eax,(%esp)
80107e47:	e8 c7 ac ff ff       	call   80102b13 <kfree>
      return 0;
80107e4c:	b8 00 00 00 00       	mov    $0x0,%eax
80107e51:	eb 16                	jmp    80107e69 <allocuvm+0x114>
  for(; a < newsz; a += PGSIZE){
80107e53:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107e5a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e5d:	3b 45 10             	cmp    0x10(%ebp),%eax
80107e60:	0f 82 2b ff ff ff    	jb     80107d91 <allocuvm+0x3c>
    }
  }
  return newsz;
80107e66:	8b 45 10             	mov    0x10(%ebp),%eax
}
80107e69:	c9                   	leave  
80107e6a:	c3                   	ret    
...
80107e6e:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
80107e71:	8b 45 10             	mov    0x10(%ebp),%eax
80107e74:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107e77:	72 08                	jb     80107e81 <deallocuvm+0x16>
    return oldsz;
80107e79:	8b 45 0c             	mov    0xc(%ebp),%eax
80107e7c:	e9 ae 00 00 00       	jmp    80107f2f <deallocuvm+0xc4>

  a = PGROUNDUP(newsz);
80107e81:	8b 45 10             	mov    0x10(%ebp),%eax
80107e84:	05 ff 0f 00 00       	add    $0xfff,%eax
80107e89:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107e8e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80107e91:	e9 8a 00 00 00       	jmp    80107f20 <deallocuvm+0xb5>
    pte = walkpgdir(pgdir, (char*)a, 0);
80107e96:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e99:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107ea0:	00 
80107ea1:	89 44 24 04          	mov    %eax,0x4(%esp)
80107ea5:	8b 45 08             	mov    0x8(%ebp),%eax
80107ea8:	89 04 24             	mov    %eax,(%esp)
80107eab:	e8 9b f9 ff ff       	call   8010784b <walkpgdir>
80107eb0:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80107eb3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107eb7:	75 16                	jne    80107ecf <deallocuvm+0x64>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80107eb9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ebc:	c1 e8 16             	shr    $0x16,%eax
80107ebf:	83 c0 01             	add    $0x1,%eax
80107ec2:	c1 e0 16             	shl    $0x16,%eax
80107ec5:	2d 00 10 00 00       	sub    $0x1000,%eax
80107eca:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107ecd:	eb 4a                	jmp    80107f19 <deallocuvm+0xae>
    else if((*pte & PTE_P) != 0){
80107ecf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107ed2:	8b 00                	mov    (%eax),%eax
80107ed4:	83 e0 01             	and    $0x1,%eax
80107ed7:	85 c0                	test   %eax,%eax
80107ed9:	74 3e                	je     80107f19 <deallocuvm+0xae>
      pa = PTE_ADDR(*pte);
80107edb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107ede:	8b 00                	mov    (%eax),%eax
80107ee0:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107ee5:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
80107ee8:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107eec:	75 0c                	jne    80107efa <deallocuvm+0x8f>
        panic("kfree");
80107eee:	c7 04 24 41 89 10 80 	movl   $0x80108941,(%esp)
80107ef5:	e8 68 86 ff ff       	call   80100562 <panic>
      char *v = P2V(pa);
80107efa:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107efd:	05 00 00 00 80       	add    $0x80000000,%eax
80107f02:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80107f05:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107f08:	89 04 24             	mov    %eax,(%esp)
80107f0b:	e8 03 ac ff ff       	call   80102b13 <kfree>
      *pte = 0;
80107f10:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107f13:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; a  < oldsz; a += PGSIZE){
80107f19:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107f20:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f23:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107f26:	0f 82 6a ff ff ff    	jb     80107e96 <deallocuvm+0x2b>
    }
  }
  return newsz;
...
80107f3b:	75 0c                	jne    80107f49 <freevm+0x18>
    panic("freevm: no pgdir");
80107f3d:	c7 04 24 47 89 10 80 	movl   $0x80108947,(%esp)
80107f44:	e8 19 86 ff ff       	call   80100562 <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80107f49:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107f50:	00 
80107f51:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80107f58:	80 
80107f59:	8b 45 08             	mov    0x8(%ebp),%eax
80107f5c:	89 04 24             	mov    %eax,(%esp)
80107f5f:	e8 07 ff ff ff       	call   80107e6b <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80107f64:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107f6b:	eb 45                	jmp    80107fb2 <freevm+0x81>
    if(pgdir[i] & PTE_P){
80107f6d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f70:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80107f77:	8b 45 08             	mov    0x8(%ebp),%eax
80107f7a:	01 d0                	add    %edx,%eax
80107f7c:	8b 00                	mov    (%eax),%eax
80107f7e:	83 e0 01             	and    $0x1,%eax
80107f81:	85 c0                	test   %eax,%eax
80107f83:	74 29                	je     80107fae <freevm+0x7d>
...
80107fa9:	e8 65 ab ff ff       	call   80102b13 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
80107fae:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80107fb2:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80107fb9:	76 b2                	jbe    80107f6d <freevm+0x3c>
    }
  }
  kfree((char*)pgdir);
80107fbb:	8b 45 08             	mov    0x8(%ebp),%eax
80107fbe:	89 04 24             	mov    %eax,(%esp)
80107fc1:	e8 4d ab ff ff       	call   80102b13 <kfree>
}
80107fc6:	c9                   	leave  
80107fc7:	c3                   	ret    
...
80107fcb:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80107fce:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107fd5:	00 
...
80107fe3:	e8 63 f8 ff ff       	call   8010784b <walkpgdir>
80107fe8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80107feb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107fef:	75 0c                	jne    80107ffd <clearpteu+0x35>
    panic("clearpteu");
80107ff1:	c7 04 24 58 89 10 80 	movl   $0x80108958,(%esp)
80107ff8:	e8 65 85 ff ff       	call   80100562 <panic>
  *pte &= ~PTE_U;
...
80108011:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108014:	e8 66 f9 ff ff       	call   8010797f <setupkvm>
80108019:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010801c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108020:	75 0a                	jne    8010802c <copyuvm+0x1e>
    return 0;
80108022:	b8 00 00 00 00       	mov    $0x0,%eax
80108027:	e9 03 01 00 00       	jmp    8010812f <copyuvm+0x121>
  for(i = 0; i < sz; i += PGSIZE){
8010802c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108033:	e9 d6 00 00 00       	jmp    8010810e <copyuvm+0x100>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108038:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010803b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108042:	00 
80108043:	89 44 24 04          	mov    %eax,0x4(%esp)
80108047:	8b 45 08             	mov    0x8(%ebp),%eax
8010804a:	89 04 24             	mov    %eax,(%esp)
8010804d:	e8 f9 f7 ff ff       	call   8010784b <walkpgdir>
80108052:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108055:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108059:	75 0c                	jne    80108067 <copyuvm+0x59>
      panic("copyuvm: pte should exist");
8010805b:	c7 04 24 62 89 10 80 	movl   $0x80108962,(%esp)
80108062:	e8 fb 84 ff ff       	call   80100562 <panic>
    if(!(*pte & PTE_P))
80108067:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010806a:	8b 00                	mov    (%eax),%eax
8010806c:	83 e0 01             	and    $0x1,%eax
8010806f:	85 c0                	test   %eax,%eax
80108071:	75 0c                	jne    8010807f <copyuvm+0x71>
      panic("copyuvm: page not present");
80108073:	c7 04 24 7c 89 10 80 	movl   $0x8010897c,(%esp)
8010807a:	e8 e3 84 ff ff       	call   80100562 <panic>
    pa = PTE_ADDR(*pte);
8010807f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108082:	8b 00                	mov    (%eax),%eax
80108084:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108089:	89 45 e8             	mov    %eax,-0x18(%ebp)
    flags = PTE_FLAGS(*pte);
8010808c:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010808f:	8b 00                	mov    (%eax),%eax
80108091:	25 ff 0f 00 00       	and    $0xfff,%eax
80108096:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80108099:	e8 0b ab ff ff       	call   80102ba9 <kalloc>
8010809e:	89 45 e0             	mov    %eax,-0x20(%ebp)
801080a1:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801080a5:	75 02                	jne    801080a9 <copyuvm+0x9b>
      goto bad;
801080a7:	eb 76                	jmp    8010811f <copyuvm+0x111>
    memmove(mem, (char*)P2V(pa), PGSIZE);
801080a9:	8b 45 e8             	mov    -0x18(%ebp),%eax
801080ac:	05 00 00 00 80       	add    $0x80000000,%eax
801080b1:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801080b8:	00 
801080b9:	89 44 24 04          	mov    %eax,0x4(%esp)
801080bd:	8b 45 e0             	mov    -0x20(%ebp),%eax
801080c0:	89 04 24             	mov    %eax,(%esp)
801080c3:	e8 11 d0 ff ff       	call   801050d9 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
801080c8:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801080cb:	8b 45 e0             	mov    -0x20(%ebp),%eax
801080ce:	8d 88 00 00 00 80    	lea    -0x80000000(%eax),%ecx
801080d4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080d7:	89 54 24 10          	mov    %edx,0x10(%esp)
801080db:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801080df:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801080e6:	00 
801080e7:	89 44 24 04          	mov    %eax,0x4(%esp)
801080eb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080ee:	89 04 24             	mov    %eax,(%esp)
801080f1:	e8 f1 f7 ff ff       	call   801078e7 <mappages>
801080f6:	85 c0                	test   %eax,%eax
801080f8:	79 0d                	jns    80108107 <copyuvm+0xf9>
      kfree(mem);
801080fa:	8b 45 e0             	mov    -0x20(%ebp),%eax
801080fd:	89 04 24             	mov    %eax,(%esp)
80108100:	e8 0e aa ff ff       	call   80102b13 <kfree>
      goto bad;
80108105:	eb 18                	jmp    8010811f <copyuvm+0x111>
  for(i = 0; i < sz; i += PGSIZE){
80108107:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010810e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108111:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108114:	0f 82 1e ff ff ff    	jb     80108038 <copyuvm+0x2a>
    }
  }
  return d;
8010811a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010811d:	eb 10                	jmp    8010812f <copyuvm+0x121>

bad:
  freevm(d);
8010811f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108122:	89 04 24             	mov    %eax,(%esp)
80108125:	e8 07 fe ff ff       	call   80107f31 <freevm>
  return 0;
...
80108134:	83 ec 28             	sub    $0x28,%esp
  ...
  pte = walkpgdir(pgdir, uva, 0);
80108137:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010813e:	00 
8010813f:	8b 45 0c             	mov    0xc(%ebp),%eax
80108142:	89 44 24 04          	mov    %eax,0x4(%esp)
80108146:	8b 45 08             	mov    0x8(%ebp),%eax
80108149:	89 04 24             	mov    %eax,(%esp)
8010814c:	e8 fa f6 ff ff       	call   8010784b <walkpgdir>
...
8010815e:	75 07                	jne    80108167 <uva2ka+0x36>
    return 0;
80108160:	b8 00 00 00 00       	mov    $0x0,%eax
80108165:	eb 22                	jmp    80108189 <uva2ka+0x58>
  if((*pte & PTE_U) == 0)
80108167:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010816a:	8b 00                	mov    (%eax),%eax
8010816c:	83 e0 04             	and    $0x4,%eax
8010816f:	85 c0                	test   %eax,%eax
80108171:	75 07                	jne    8010817a <uva2ka+0x49>
    return 0;
80108173:	b8 00 00 00 00       	mov    $0x0,%eax
80108178:	eb 0f                	jmp    80108189 <uva2ka+0x58>
...
8010818e:	83 ec 28             	sub    $0x28,%esp
  ...
  buf = (char*)p;
80108191:	8b 45 10             	mov    0x10(%ebp),%eax
80108194:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108197:	e9 87 00 00 00       	jmp    80108223 <copyout+0x98>
    va0 = (uint)PGROUNDDOWN(va);
8010819c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010819f:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801081a4:	89 45 ec             	mov    %eax,-0x14(%ebp)
...
801081b4:	e8 78 ff ff ff       	call   80108131 <uva2ka>
801081b9:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
801081bc:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801081c0:	75 07                	jne    801081c9 <copyout+0x3e>
      return -1;
801081c2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801081c7:	eb 69                	jmp    80108232 <copyout+0xa7>
    n = PGSIZE - (va - va0);
801081c9:	8b 45 0c             	mov    0xc(%ebp),%eax
801081cc:	8b 55 ec             	mov    -0x14(%ebp),%edx
801081cf:	29 c2                	sub    %eax,%edx
801081d1:	89 d0                	mov    %edx,%eax
801081d3:	05 00 10 00 00       	add    $0x1000,%eax
801081d8:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
801081db:	8b 45 f0             	mov    -0x10(%ebp),%eax
801081de:	3b 45 14             	cmp    0x14(%ebp),%eax
801081e1:	76 06                	jbe    801081e9 <copyout+0x5e>
      n = len;
801081e3:	8b 45 14             	mov    0x14(%ebp),%eax
801081e6:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
801081e9:	8b 45 ec             	mov    -0x14(%ebp),%eax
801081ec:	8b 55 0c             	mov    0xc(%ebp),%edx
801081ef:	29 c2                	sub    %eax,%edx
801081f1:	8b 45 e8             	mov    -0x18(%ebp),%eax
801081f4:	01 c2                	add    %eax,%edx
801081f6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801081f9:	89 44 24 08          	mov    %eax,0x8(%esp)
801081fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108200:	89 44 24 04          	mov    %eax,0x4(%esp)
80108204:	89 14 24             	mov    %edx,(%esp)
80108207:	e8 cd ce ff ff       	call   801050d9 <memmove>
    len -= n;
8010820c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010820f:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108212:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108215:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108218:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010821b:	05 00 10 00 00       	add    $0x1000,%eax
80108220:	89 45 0c             	mov    %eax,0xc(%ebp)
  while(len > 0){
80108223:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108227:	0f 85 6f ff ff ff    	jne    8010819c <copyout+0x11>
  }
  return 0;
