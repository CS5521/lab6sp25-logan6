...
main(int argc, char * argv[])
{
   ...
   int numForks = fkc();
   9:	e8 80 03 00 00       	call   38e <fkc>
   e:	89 44 24 1c          	mov    %eax,0x1c(%esp)
   printf(1, "%d\n", numForks);
  12:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  16:	89 44 24 08          	mov    %eax,0x8(%esp)
  1a:	c7 44 24 04 42 08 00 	movl   $0x842,0x4(%esp)
  21:	00 
  22:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  29:	e8 48 04 00 00       	call   476 <printf>
   if(fork() == 0)
  2e:	e8 ab 02 00 00       	call   2de <fork>
  33:	85 c0                	test   %eax,%eax
  35:	75 05                	jne    3c <main+0x3c>
   {
      exit();
  37:	e8 aa 02 00 00       	call   2e6 <exit>
   }
   if(fork() == 0)
  3c:	e8 9d 02 00 00       	call   2de <fork>
  41:	85 c0                	test   %eax,%eax
  43:	75 05                	jne    4a <main+0x4a>
   {
      exit();
  45:	e8 9c 02 00 00       	call   2e6 <exit>
   }
   wait();
  4a:	e8 9f 02 00 00       	call   2ee <wait>
   wait();
  4f:	e8 9a 02 00 00       	call   2ee <wait>
   numForks = fkc();
  54:	e8 35 03 00 00       	call   38e <fkc>
  59:	89 44 24 1c          	mov    %eax,0x1c(%esp)
   printf(1, "%d\n", numForks);
  5d:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  61:	89 44 24 08          	mov    %eax,0x8(%esp)
  65:	c7 44 24 04 42 08 00 	movl   $0x842,0x4(%esp)
  6c:	00 
  6d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  74:	e8 fd 03 00 00       	call   476 <printf>
   exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40f:	0f b6 80 94 0a 00 00 	movzbl 0xa94(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 56c:	75 09                	jne    577 <printf+0x101>
          s = "(null)";
 56e:	c7 45 f4 46 08 00 00 	movl   $0x846,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 638:	a1 b0 0a 00 00       	mov    0xab0,%eax
 ...
 703:	a3 b0 0a 00 00       	mov    %eax,0xab0
}
 708:	c9                   	leave  
 709:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 774:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 777:	a1 b0 0a 00 00       	mov    0xab0,%eax
 77c:	89 45 f0             	mov    %eax,-0x10(%ebp)
 77f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 783:	75 23                	jne    7a8 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 785:	c7 45 f0 a8 0a 00 00 	movl   $0xaa8,-0x10(%ebp)
 78c:	8b 45 f0             	mov    -0x10(%ebp),%eax
 78f:	a3 b0 0a 00 00       	mov    %eax,0xab0
 794:	a1 b0 0a 00 00       	mov    0xab0,%eax
 799:	a3 a8 0a 00 00       	mov    %eax,0xaa8
    base.s.size = 0;
 79e:	c7 05 ac 0a 00 00 00 	movl   $0x0,0xaac
 7a5:	00 00 00 
  }
 ...
 7fb:	a3 b0 0a 00 00       	mov    %eax,0xab0
      return (void*)(p + 1);
 ...
 806:	eb 38                	jmp    840 <malloc+0xde>
    ...
    if(p == freep)
 808:	a1 b0 0a 00 00       	mov    0xab0,%eax
