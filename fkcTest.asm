...
main(int argc, char * argv[])
{
  ...
  wait();
  c1:	e8 c7 02 00 00       	call   38d <wait>

  if(fork() == 0)
  c6:	e8 b2 02 00 00       	call   37d <fork>
  cb:	85 c0                	test   %eax,%eax
  cd:	75 05                	jne    d4 <main+0xd4>
  {
    exit();
  cf:	e8 b1 02 00 00       	call   385 <exit>
  }
  wait();
  d4:	e8 b4 02 00 00       	call   38d <wait>
  if(fork() == 0)
  d9:	e8 9f 02 00 00       	call   37d <fork>
  de:	85 c0                	test   %eax,%eax
  e0:	75 05                	jne    e7 <main+0xe7>
  {
    exit();
  e2:	e8 9e 02 00 00       	call   385 <exit>
  }
  wait();
  ...
  f8:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  printf(1, "number of forks after 3 more forks: %d\n", numForks);
  fc:	8b 44 24 1c          	mov    0x1c(%esp),%eax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ae:	0f b6 80 e0 0b 00 00 	movzbl 0xbe0(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 60b:	75 09                	jne    616 <printf+0x101>
          s = "(null)";
 60d:	c7 45 f4 94 09 00 00 	movl   $0x994,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d7:	a1 fc 0b 00 00       	mov    0xbfc,%eax
 ...
 7a2:	a3 fc 0b 00 00       	mov    %eax,0xbfc
}
 7a7:	c9                   	leave  
 7a8:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7f5:	e8 ce fe ff ff       	call   6c8 <free>
  return freep;
 7fa:	a1 fc 0b 00 00       	mov    0xbfc,%eax
}
 7ff:	c9                   	leave  
 800:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 813:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 816:	a1 fc 0b 00 00       	mov    0xbfc,%eax
 81b:	89 45 f0             	mov    %eax,-0x10(%ebp)
 81e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 822:	75 23                	jne    847 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 824:	c7 45 f0 f4 0b 00 00 	movl   $0xbf4,-0x10(%ebp)
 82b:	8b 45 f0             	mov    -0x10(%ebp),%eax
 82e:	a3 fc 0b 00 00       	mov    %eax,0xbfc
 833:	a1 fc 0b 00 00       	mov    0xbfc,%eax
 838:	a3 f4 0b 00 00       	mov    %eax,0xbf4
    base.s.size = 0;
 83d:	c7 05 f8 0b 00 00 00 	movl   $0x0,0xbf8
 844:	00 00 00 
  }
 ...
 89a:	a3 fc 0b 00 00       	mov    %eax,0xbfc
      return (void*)(p + 1);
 ...
 8a5:	eb 38                	jmp    8df <malloc+0xde>
    ...
    if(p == freep)
 8a7:	a1 fc 0b 00 00       	mov    0xbfc,%eax
